  ...
  h.fn.bootpag = function(p) {
    ...
    var l = this,
      a = h.extend({
        ...
        wrapClass: "pagination bootpag m-0",
    ...
    return this.each(function() {
      var c, b, d = h(this);
      c = ['<ul class="', a.wrapClass, '">'];
      a.firstLastUse && (c = c.concat(['<li data-lp="1" class="', a.firstClass, '"><a class="page-link" href="', g(1), '">', a.first, "</a></li>"]));
      a.prev && (c = c.concat(['<li data-lp="1" class="', a.prevClass, '"><a class="page-link" href="', g(1), '">', a.prev, "</a></li>"]));
      for (b =
        1; b <= Math.min(a.total, a.maxVisible); b++) c = c.concat(['<li data-lp="', b, '"><a class="page-link" href="', g(b), '">', b, "</a></li>"]);
      a.next && (b = a.leaps && a.total > a.maxVisible ? Math.min(a.maxVisible + 1, a.total) : 2, c = c.concat(['<li data-lp="', b, '" class="', a.nextClass, '"><a class="page-link" href="', g(b), '">', a.next, "</a></li>"]));
      a.firstLastUse && (c = c.concat(['<li data-lp="', a.total, '" class="last"><a class="page-link" href="', g(a.total), '">', a.last, "</a></li>"]));
      c.push("</ul>");
