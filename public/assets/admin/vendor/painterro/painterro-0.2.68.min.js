var Painterro = function(A) {
  function e(r) {
    ...
    return A[r].call(i.exports, i, i.exports, e), i.l = !0, i.exports
  }
  var t = {};
  ...
  function n(A) {
    ...
    if ((u === r || !u) && setTimeout) return u = setTimeout, setTimeout(A, 0);
    try {
      return u(A, 0)
    } catch (e) {
      try {
  ...
  function o(A) {
    if (B === clearTimeout) return clearTimeout(A);
    if ((B === i || !B) && clearTimeout) return B = clearTimeout, clearTimeout(A);
    try {
      return B(A)
    } catch (e) {
      try {
  ...
  function a() {
    w && h && (w = !1, h.length ? d = h.concat(d) : Q = -1, d.length && s())
  }
  ...
  ! function() {
    ...
    try {
      B = "function" == typeof clearTimeout ? clearTimeout : i
    } catch (A) {
      B = i
    }
  }();
  ...
  g.nextTick = function(A) {
    ...
    d.push(new l(A, e)), 1 !== d.length || w || n(s)
  }, l.prototype.run = function() {
    this.fun.apply(null, this.array)
  }, g.title = "browser", g.browser = !0, g.env = {}, g.argv = [], g.version = "", g.versions = {}, g.on = c, g.addListener = c, g.once = c, g.off = c, g.removeListener = c, g.removeAllListeners = c, g.emit = c, g.prependListener = c, g.prependOnceListener = c, g.listeners = function(A) {
    return []
  ...
  function r() {
    for (var A = "ptro", e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", t = 0; t < 8; t += 1) A += e.charAt(Math.floor(Math.random() * e.length));
    return A
  }
  ...
  function i() {
    "documentOffsetTop" in Element.prototype || Object.defineProperty(Element.prototype, "documentOffsetTop", {
      ...
      get: function() {
        var A = this.getBoundingClientRect();
        return A.height ? A.height : A.bottom - A.top
      }
    })
  }
  ...
  function n() {
    var A = null;
    window.getSelection ? A = window.getSelection() : document.selection && (A = document.selection), A && (A.empty && A.empty(), A.removeAllRanges && A.removeAllRanges())
  }
  ...
  function s(A) {
    if (window.clipboardData && window.clipboardData.setData) window.clipboardData.setData("Text", A);
    else if (document.queryCommandSupported && document.queryCommandSupported("copy")) {
      var e = document.createElement("textarea");
      e.textContent = A, e.style.position = "fixed", document.getElementById("js-paint-section").appendChild(e), e.select();
      try {
        document.execCommand("copy")
      } catch (A) {
        console.warn("Copy to clipboard failed.", A)
      } finally {
        document.getElementById("js-paint-section").removeChild(e)
      }
    }
  }
  ...
  function l() {
    ...
    A.style.visibility = "hidden", A.style.width = "100px", A.style.msOverflowStyle = "scrollbar", document.getElementById("js-paint-section").appendChild(A);
    var e = A.offsetWidth;
    A.style.overflow = "scroll";
    var t = document.createElement("div");
    t.style.width = "100%", A.appendChild(t);
    var r = t.offsetWidth;
    return A.parentNode.removeChild(A), e - r
  }
  ...
  function c(A, e) {
    ...
    }, t.open("GET", A), t.responseType = "blob", t.send()
  }

  function u(A) {
    console.error("[Painterro] " + A)
  }
  ...
  Object.defineProperty(e, "__esModule", {
    value: !0
  }), e.genId = r, e.addDocumentObjectHelpers = i, e.clearSelection = n, e.distance = o, e.trim = a, e.copyToClipboard = s, e.getScrollbarWidth = l, e.imgToDataURL = c, e.logError = u, e.checkIn = B;
  e.KEYS = {
    y: 89,
    z: 90,
    s: 83,
  ...
  (function(A) {
    ...
    var n = function() {
      ...
      u = (e.parseBounds = function(A, e, t) {
        ...
        return new c(A.left + e[3].borderWidth, A.top + e[0].borderWidth, A.width - (e[1].borderWidth + e[3].borderWidth), A.height - (e[0].borderWidth + e[2].borderWidth))
      }, e.calculateContentBox = function(A, e, t) {
        var r = e[0].value,
          i = e[1].value,
          n = e[2].value,
          o = e[3].value;
        return new c(A.left + o + t[3].borderWidth, A.top + r + t[0].borderWidth, A.width - (t[1].borderWidth + t[3].borderWidth + o + i), A.height - (t[0].borderWidth + t[2].borderWidth + r + n))
      }, e.parseDocumentSize = function(e) {
        var t = e.body,
          r = e.documentElement;
        if (!t || !r) throw new Error("production" !== A.env.NODE_ENV ? "Unable to get document size" : "");
        var i = Math.max(Math.max(t.scrollWidth, r.scrollWidth), Math.max(t.offsetWidth, r.offsetWidth), Math.max(t.clientWidth, r.clientWidth)),
          n = Math.max(Math.max(t.scrollHeight, r.scrollHeight), Math.max(t.offsetHeight, r.offsetHeight), Math.max(t.clientHeight, r.clientHeight));
        return new c(0, 0, i, n)
        ...
        var i = [];
        return A instanceof l.default ? i.push(A.subdivide(.5, !1)) : i.push(A), t instanceof l.default ? i.push(t.subdivide(.5, !0)) : i.push(t), r instanceof l.default ? i.push(r.subdivide(.5, !0).reverse()) : i.push(r), e instanceof l.default ? i.push(e.subdivide(.5, !1).reverse()) : i.push(e), i
      }),
      B = (e.calculateBorderBoxPath = function(A) {
        ...
        var r = t[B.TOP_LEFT][0].getAbsoluteValue(A.width),
          i = t[B.TOP_LEFT][1].getAbsoluteValue(A.height),
          n = t[B.TOP_RIGHT][0].getAbsoluteValue(A.width),
          o = t[B.TOP_RIGHT][1].getAbsoluteValue(A.height),
          s = t[B.BOTTOM_RIGHT][0].getAbsoluteValue(A.width),
          l = t[B.BOTTOM_RIGHT][1].getAbsoluteValue(A.height),
          c = t[B.BOTTOM_LEFT][0].getAbsoluteValue(A.width),
          u = t[B.BOTTOM_LEFT][1].getAbsoluteValue(A.height),
          h = [];
        h.push((r + n) / A.width), h.push((c + s) / A.width), h.push((i + u) / A.height), h.push((o + l) / A.height);
        var d = Math.max.apply(Math, h);
        d > 1 && (r /= d, i /= d, n /= d, o /= d, s /= d, l /= d, c /= d, u /= d);
        var w = A.width - n,
          Q = A.height - l,
          p = A.width - s,
          C = A.height - u;
        return {
          topLeftOuter: r > 0 || i > 0 ? g(A.left, A.top, r, i, B.TOP_LEFT) : new a.default(A.left, A.top),
          topLeftInner: r > 0 || i > 0 ? g(A.left + e[3].borderWidth, A.top + e[0].borderWidth, Math.max(0, r - e[3].borderWidth), Math.max(0, i - e[0].borderWidth), B.TOP_LEFT) : new a.default(A.left + e[3].borderWidth, A.top + e[0].borderWidth),
          topRightOuter: n > 0 || o > 0 ? g(A.left + w, A.top, n, o, B.TOP_RIGHT) : new a.default(A.left + A.width, A.top),
          topRightInner: n > 0 || o > 0 ? g(A.left + Math.min(w, A.width + e[3].borderWidth), A.top + e[0].borderWidth, w > A.width + e[3].borderWidth ? 0 : n - e[3].borderWidth, o - e[0].borderWidth, B.TOP_RIGHT) : new a.default(A.left + A.width - e[1].borderWidth, A.top + e[0].borderWidth),
          bottomRightOuter: s > 0 || l > 0 ? g(A.left + p, A.top + Q, s, l, B.BOTTOM_RIGHT) : new a.default(A.left + A.width, A.top + A.height),
          bottomRightInner: s > 0 || l > 0 ? g(A.left + Math.min(p, A.width - e[3].borderWidth), A.top + Math.min(Q, A.height + e[0].borderWidth), Math.max(0, s - e[1].borderWidth), l - e[2].borderWidth, B.BOTTOM_RIGHT) : new a.default(A.left + A.width - e[1].borderWidth, A.top + A.height - e[2].borderWidth),
          bottomLeftOuter: c > 0 || u > 0 ? g(A.left, A.top + C, c, u, B.BOTTOM_LEFT) : new a.default(A.left, A.top + A.height),
          bottomLeftInner: c > 0 || u > 0 ? g(A.left + e[3].borderWidth, A.top + C, Math.max(0, c - e[3].borderWidth), u - e[2].borderWidth, B.BOTTOM_LEFT) : new a.default(A.left + e[3].borderWidth, A.top + A.height - e[2].borderWidth)
        }
      }, {
        TOP_LEFT: 0,
        TOP_RIGHT: 1,
      ...
      g = function(A, e, t, r, i) {
        ...
        switch (i) {
          case B.TOP_LEFT:
            return new l.default(new a.default(A, u), new a.default(A, u - s), new a.default(c - o, e), new a.default(c, e));
          case B.TOP_RIGHT:
            return new l.default(new a.default(A, e), new a.default(A + o, e), new a.default(c, u - s), new a.default(c, u));
          case B.BOTTOM_RIGHT:
            return new l.default(new a.default(c, e), new a.default(c, e + s), new a.default(A + o, u), new a.default(A, u));
          case B.BOTTOM_LEFT:
          default:
            return new l.default(new a.default(c, u), new a.default(c - o, u), new a.default(A, e + s), new a.default(A, e))
        }
      }
  }).call(e, t(0))
}, function(A, e, t) {
  ...
  var i = function() {
      function A(A, e) {
        var t = [],
          ...
          n = void 0;
        try {
          for (var o, a = A[Symbol.iterator](); !(r = (o = a.next()).done) && (t.push(o.value), !e || t.length !== e); r = !0);
        } catch (A) {
          i = !0, n = A
        } finally {
          try {
    ...
    d = function(A) {
      var e = Q[A.toLowerCase()];
      return e || !1
    },
    w = function() {
      function A(e) {
        r(this, A);
        var t = Array.isArray(e) ? h(e) : a(e) || u(e) || g(e) || d(e) || l(e) || [0, 0, 0, null],
          n = i(t, 4),
          o = n[0],
          s = n[1],
          c = n[2],
          B = n[3];
        this.r = o, this.g = s, this.b = c, this.a = B
      }
      return n(A, [{
        key: "isTransparent",
        value: function() {
  ...
  var o = null,
    a = function() {
      function A() {
        ...
        }, this.activate("en"), this.defaultTranslator = this.translations.en
      }
      return n(A, [{
        key: "addTranslation",
        value: function(A, e) {
          this.translations[A] = e
        }
      }, {
        key: "activate",
        value: function(A) {
          void 0 !== this.translations[A] ? (this.trans = A, this.translator = this.translations[this.trans]) : this.translator = this.defaultTranslator
        }
      }, {
        key: "tr",
        value: function(A) {
  ...
  (function(A) {
    ...
    var i = function() {
      ...
      a = function() {
        function e(t) {
          r(this, e), this.type = "%" === t.substr(t.length - 1) ? o.PERCENTAGE : o.PX;
          var i = parseFloat(t);
          "production" !== A.env.NODE_ENV && isNaN(i) && console.error('Invalid value given for Length: "' + t + '"'), this.value = isNaN(i) ? 0 : i
        }
        return i(e, [{
          key: "isPercentage",
          value: function() {
    ...
    e.calculateLengthFromValueWithUnit = function(A, e, t) {
      switch (t) {
        ...
        case "rem":
          var r = new a(e);
          return r.value *= "em" === t ? parseFloat(A.style.font.fontSize) : s(A), r;
        default:
          return new a("0")
      }
    }
  ...
  (function(A) {
    ...
    var i = function() {
      ...
      v = function() {
        function e(t, i, n, a) {
          var v = this;
          r(this, e), this.parent = i, this.tagName = t.tagName, this.index = a, this.childNodes = [], this.listItems = [], "number" == typeof t.start && (this.listStart = t.start);
          var z = t.ownerDocument.defaultView,
            k = z.pageXOffset,
            x = z.pageYOffset,
            S = z.getComputedStyle(t, null),
            L = (0, u.parseDisplay)(S.display),
            j = "radio" === t.type || "checkbox" === t.type,
            K = (0, M.parsePosition)(S.position);
          if (this.style = {
              background: j ? m.INPUT_BACKGROUND : (0, s.parseBackground)(S, n),
              border: j ? m.INPUT_BORDERS : (0, l.parseBorder)(S),
              borderRadius: (t instanceof z.HTMLInputElement || t instanceof HTMLInputElement) && j ? (0, m.getInputBorderRadius)(t) : (0, c.parseBorderRadius)(S),
              color: j ? m.INPUT_COLOR : new o.default(S.color),
              display: L,
              float: (0, B.parseCSSFloat)(S.float),
              font: (0, g.parseFont)(S),
              letterSpacing: (0, h.parseLetterSpacing)(S.letterSpacing),
              listStyle: L === u.DISPLAY.LIST_ITEM ? (0, w.parseListStyle)(S) : null,
              lineBreak: (0, d.parseLineBreak)(S.lineBreak),
              margin: (0, Q.parseMargin)(S),
              opacity: parseFloat(S.opacity),
              overflow: -1 === H.indexOf(t.tagName) ? (0, p.parseOverflow)(S.overflow) : p.OVERFLOW.HIDDEN,
              overflowWrap: (0, C.parseOverflowWrap)(S.overflowWrap ? S.overflowWrap : S.wordWrap),
              padding: (0, f.parsePadding)(S),
              position: K,
              textDecoration: (0, U.parseTextDecoration)(S),
              textShadow: (0, N.parseTextShadow)(S.textShadow),
              textTransform: (0, I.parseTextTransform)(S.textTransform),
              transform: (0, T.parseTransform)(S),
              visibility: (0, E.parseVisibility)(S.visibility),
              wordBreak: (0, D.parseWordBreak)(S.wordBreak),
              zIndex: (0, F.parseZIndex)(K !== M.POSITION.STATIC ? S.zIndex : "auto")
            }, this.isTransformed() && (t.style.transform = "matrix(1,0,0,1,0,0)"), L === u.DISPLAY.LIST_ITEM) {
            var Y = (0, O.getListOwner)(this);
            if (Y) {
              var R = Y.listItems.length;
              Y.listItems.push(this), this.listIndex = t.hasAttribute("value") && "number" == typeof t.value ? t.value : 0 === R ? "number" == typeof Y.listStart ? Y.listStart : 1 : Y.listItems[R - 1].listIndex + 1
            }
          }
          "IMG" === t.tagName && t.addEventListener("load", function() {
            v.bounds = (0, y.parseBounds)(t, k, x), v.curvedBounds = (0, y.parseBoundCurves)(v.bounds, v.style.border, v.style.borderRadius)
          }), this.image = b(t, n), this.bounds = j ? (0, m.reformatInputBounds)((0, y.parseBounds)(t, k, x)) : (0, y.parseBounds)(t, k, x), this.curvedBounds = (0, y.parseBoundCurves)(this.bounds, this.style.border, this.style.borderRadius), "production" !== A.env.NODE_ENV && (this.name = t.tagName.toLowerCase() + (t.id ? "#" + t.id : "") + t.className.toString().split(" ").map(function(A) {
            return A.length ? "." + A : ""
          }).join(""))
        }
        return i(e, [{
          ...
          key: "isVisible",
          value: function() {
            return !(0, a.contains)(this.style.display, u.DISPLAY.NONE) && this.style.opacity > 0 && this.style.visibility === E.VISIBILITY.VISIBLE
          }
        }, {
    ...
    var b = function(A, e) {
      ...
      switch (A.tagName) {
        ...
        case "CANVAS":
          var i = A;
          return e.loadCanvas(i);
        case "IFRAME":
          var n = A.getAttribute("data-html2canvas-internal-iframe-key");
          if (n) return n
      }
      return null
    }
    ...
    var n = t(3),
      ...
      f = (e.calculateBackgroundSize = function(A, e, t) {
        var r = 0,
          i = 0,
          n = A.size;
        if (n[0].size === w.CONTAIN || n[0].size === w.COVER) {
          var o = t.width / t.height,
            a = e.width / e.height;
          return o < a != (n[0].size === w.COVER) ? new c.default(t.width, t.width / a) : new c.default(t.height * a, t.height)
        }
        return n[0].value && (r = n[0].value.getAbsoluteValue(t.width)), n[0].size === w.AUTO && n[1].size === w.AUTO ? i = e.height : n[1].size === w.AUTO ? i = r / e.width * e.height : n[1].value && (i = n[1].value.getAbsoluteValue(t.height)), n[0].size === w.AUTO && (r = i / e.height * e.width), new c.default(r, i)
      }, e.calculateGradientBackgroundSize = function(A, e) {
        var t = A.size,
          r = t[0].value ? t[0].value.getAbsoluteValue(e.width) : e.width,
          i = t[1].value ? t[1].value.getAbsoluteValue(e.height) : t[0].value ? r : e.height;
        return new c.default(r, i)
      }, new C("auto")),
      M = (e.calculateBackgroungPaintingArea = function(A, e) {
        switch (e) {
          case Q.BORDER_BOX:
            return (0, g.calculateBorderBoxPath)(A);
          case Q.PADDING_BOX:
          default:
            return (0, g.calculatePaddingBoxPath)(A)
        }
      }, e.calculateBackgroungPositioningArea = function(A, e, t, r) {
        var i = (0, g.calculatePaddingBox)(e, r);
        switch (A) {
          case p.BORDER_BOX:
            return e;
          case p.CONTENT_BOX:
            var n = t[h.PADDING_SIDES.LEFT].getAbsoluteValue(e.width),
              o = t[h.PADDING_SIDES.RIGHT].getAbsoluteValue(e.width),
              a = t[h.PADDING_SIDES.TOP].getAbsoluteValue(e.width),
              s = t[h.PADDING_SIDES.BOTTOM].getAbsoluteValue(e.width);
            return new g.Bounds(i.left + n, i.top + a, i.width - n - o, i.height - a - s);
          case p.PADDING_BOX:
          default:
            return i
        }
      ...
      }, e.calculateBackgroundRepeatPath = function(A, e, t, r, i) {
        switch (A.repeat) {
          case d.REPEAT_X:
            return [new B.default(Math.round(i.left), Math.round(r.top + e.y)), new B.default(Math.round(i.left + i.width), Math.round(r.top + e.y)), new B.default(Math.round(i.left + i.width), Math.round(t.height + r.top + e.y)), new B.default(Math.round(i.left), Math.round(t.height + r.top + e.y))];
          case d.REPEAT_Y:
            return [new B.default(Math.round(r.left + e.x), Math.round(i.top)), new B.default(Math.round(r.left + e.x + t.width), Math.round(i.top)), new B.default(Math.round(r.left + e.x + t.width), Math.round(i.height + i.top)), new B.default(Math.round(r.left + e.x), Math.round(i.height + i.top))];
          case d.NO_REPEAT:
            return [new B.default(Math.round(r.left + e.x), Math.round(r.top + e.y)), new B.default(Math.round(r.left + e.x + t.width), Math.round(r.top + e.y)), new B.default(Math.round(r.left + e.x + t.width), Math.round(r.top + e.y + t.height)), new B.default(Math.round(r.left + e.x), Math.round(r.top + e.y + t.height))];
          default:
            return [new B.default(Math.round(i.left), Math.round(i.top)), new B.default(Math.round(i.left + i.width), Math.round(i.top)), new B.default(Math.round(i.left + i.width), Math.round(i.height + i.top)), new B.default(Math.round(i.left), Math.round(i.height + i.top))]
        }
      }, e.parseBackground = function(A, e) {
        return {
          backgroundColor: new o.default(A.backgroundColor),
          backgroundImage: I(A, e),
          backgroundClip: M(A.backgroundClip),
          backgroundOrigin: U(A.backgroundOrigin)
        }
      }, function(A) {
        switch (A) {
          case "padding-box":
      ...
      N = function(e) {
        ...
        return "production" !== A.env.NODE_ENV && console.error('Invalid background-repeat value "' + e + '"'), d.REPEAT
      },
      I = function(A, e) {
        var t = D(A.backgroundImage).map(function(A) {
            if ("url" === A.method) {
          ...
          i = A.backgroundRepeat.split(","),
          n = A.backgroundSize.split(",");
        return t.map(function(A, e) {
          var t = (n[e] || "auto").trim().split(" ").map(T),
            o = (r[e] || "auto").trim().split(" ").map(E);
          return {
            source: A,
            repeat: N("string" == typeof i[e] ? i[e] : i[0]),
      ...
      D = e.parseBackgroundImage = function(A) {
        var e = /^\s$/,
          t = [],
          r = [],
          i = "",
          ...
          l = function() {
            ...
            if (i) {
              ...
              var e = i.indexOf("-", 1) + 1;
              "-" === i.substr(0, 1) && e > 0 && (A = i.substr(0, e).toLowerCase(), i = i.substr(e)), i = i.toLowerCase(), "none" !== i && t.push({
                prefix: A,
                method: i,
                args: r
              })
          ...
          if (0 !== a || !e.test(A)) {
            switch (A) {
              ...
              case ")":
                if (n) break;
                if (1 === a) {
                  if (0 === s) return a = 0, void l();
                  s--
                }
                break;
              case ",":
                if (n) break;
                if (0 === a) return void l();
                if (1 === a && 0 === s && !i.match(/^url$/i)) return r.push(o.trim()), void(o = "")
            }
            0 === a ? i += A : o += A
          }
        }), l(), t
  ...
  var r = t(36),
    ...
    n = function(A, e) {
      ...
      return new Promise(function(A) {
        ...
        var n = function() {
          try {
            i.drawImage(t, 0, 0), r.toDataURL()
          } catch (e) {
            return A(!1)
          }
          return A(!0)
        };
        t.onload = n, t.onerror = function() {
          return A(!1)
    ...
    c = function(A) {
      ...
      var i = new Image,
        n = e.toDataURL();
      i.src = n;
      var o = (0, r.createForeignObjectSVG)(100, 100, 0, 0, i);
      return t.fillStyle = "red", t.fillRect(0, 0, 100, 100), (0, r.loadSerializedSVG)(o).then(function(e) {
        t.drawImage(e, 0, 0);
        var i = t.getImageData(0, 0, 100, 100).data;
        t.fillStyle = "red", t.fillRect(0, 0, 100, 100);
        var o = A.createElement("div");
        return o.style.backgroundImage = "url(" + n + ")", o.style.height = "100px", l(i) ? (0, r.loadSerializedSVG)((0, r.createForeignObjectSVG)(100, 100, 0, 0, o)) : Promise.reject(!1)
      }).then(function(A) {
        return t.drawImage(A, 0, 0), l(t.getImageData(0, 0, 100, 100).data)
      }).catch(function(A) {
        return !1
      })
    },
  ...
  var n = function() {
    ...
    s = function() {
      function A(e, t, i) {
        r(this, A), this.text = e, this.parent = t, this.bounds = i
      }
      return n(A, null, [{
        key: "fromTextNode",
        value: function(e, t) {
  ...
  (function(A) {
    ...
    var i = t(11),
      n = function e(t, n) {
        r(this, e), this.type = i.PATH.VECTOR, this.x = t, this.y = n, "production" !== A.env.NODE_ENV && (isNaN(t) && console.error("Invalid x value given for Vector"), isNaN(n) && console.error("Invalid y value given for Vector"))
      };
    e.default = n
  }).call(e, t(0))
}, function(A, e, t) {
  ...
  function r() {
    try {
      g = JSON.parse(localStorage.getItem(B))
    } catch (A) {
      console.error("Unable get from localstorage: " + A)
    }
    g || (g = {})
  }
  ...
  for (var r = (e.toCodePoints = function(A) {
      for (var e = [], t = 0, r = A.length; t < r;) {
        var i = A.charCodeAt(t++);
        if (i >= 55296 && i <= 56319 && t < r) {
          var n = A.charCodeAt(t++);
          56320 == (64512 & n) ? e.push(((1023 & i) << 10) + (1023 & n) + 65536) : (e.push(i), t--)
        } else e.push(i)
      }
      return e
      ...
      for (var e = [], t = -1, r = ""; ++t < A;) {
        ...
        i <= 65535 ? e.push(i) : (i -= 65536, e.push(55296 + (i >> 10), i % 1024 + 56320)), (t + 1 === A || e.length > 16384) && (r += String.fromCharCode.apply(String, e), e.length = 0)
      }
      return r
    }, "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"), i = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256), n = 0; n < r.length; n++) i[r.charCodeAt(n)] = n;
  e.decode = function(A) {
    var e = .75 * A.length,
      t = A.length,
      r = void 0,
    ...
    for (r = 0; r < t; r += 4) o = i[A.charCodeAt(r)], a = i[A.charCodeAt(r + 1)], s = i[A.charCodeAt(r + 2)], l = i[A.charCodeAt(r + 3)], u[n++] = o << 2 | a >> 4, u[n++] = (15 & a) << 4 | s >> 2, u[n++] = (3 & s) << 6 | 63 & l;
    return c
  ...
  var i = t(7),
    ...
    c = t(30),
    u = ["OL", "UL", "MENU"],
    B = (e.getListOwner = function(A) {
      var e = A.parent;
      if (!e) return null;
      do {
        if (-1 !== u.indexOf(e.tagName)) return e;
        e = e.parent
      } while (e);
      return A.parent
      ...
      if (r) {
        ...
        switch ((0, i.copyCSSStyles)(n, a), a.style.position = "absolute", a.style.bottom = "auto", a.style.display = "block", a.style.letterSpacing = "normal", r.listStylePosition) {
          case l.LIST_STYLE_POSITION.OUTSIDE:
            a.style.left = "auto", a.style.right = A.ownerDocument.defaultView.innerWidth - e.bounds.left - e.style.margin[1].getAbsoluteValue(e.bounds.width) + 7 + "px", a.style.textAlign = "right";
            break;
          case l.LIST_STYLE_POSITION.INSIDE:
        ...
        if (B)
          if ("url" === B.method) {
            ...
            g.src = B.args[0], a.style.top = e.bounds.top - u + "px", a.style.width = "auto", a.style.height = "auto", a.appendChild(g)
          } else {
            var h = .5 * parseFloat(e.style.font.fontSize);
            a.style.top = e.bounds.top - u + e.bounds.height - 1.5 * h + "px", a.style.width = h + "px", a.style.height = h + "px", a.style.backgroundImage = n.listStyleImage
          }
        else "number" == typeof e.listIndex && (c = A.ownerDocument.createTextNode(M(e.listIndex, r.listStyleType, !0)), a.appendChild(c), a.style.top = e.bounds.top - u + "px");
        var d = A.ownerDocument.body;
        d.appendChild(a), c ? (e.childNodes.push(s.default.fromTextNode(c, e)), d.removeChild(a)) : e.childNodes.push(new o.default(a, e, t, 0))
      }
    }, {
    ...
    w = function(A, e, t, r, i, n) {
      return A < e || A > t ? M(A, i, n.length > 0) : r.integers.reduce(function(e, t, i) {
        for (; A >= t;) A -= t, e += r.values[i];
        return e
      }, "") + n
    },
    Q = function(A, e, t, r) {
    ...
    p = function(A, e, t, r, i) {
      var n = t - e + 1;
      return (A < 0 ? "-" : "") + (Q(Math.abs(A), n, r, function(A) {
        return (0, c.fromCodePoint)(Math.floor(A % n) + e)
      }) + i)
    },
    C = function(A, e) {
    ...
    f = function(A, e, t, r, n, o) {
      if (A < -9999 || A > 9999) return M(A, l.LIST_STYLE_TYPE.CJK_DECIMAL, n.length > 0);
      var a = Math.abs(A),
        s = n;
      if (0 === a) return e[0] + s;
      for (var c = 0; a > 0 && c <= 4; c++) {
        var u = a % 10;
        0 === u && (0, i.contains)(o, 1) && "" !== s ? s = e[u] + s : u > 1 || 1 === u && 0 === c || 1 === u && 1 === c && (0, i.contains)(o, 2) || 1 === u && 1 === c && (0, i.contains)(o, 4) && A > 100 || 1 === u && c > 1 && (0, i.contains)(o, 8) ? s = e[u] + (c > 0 ? t[c - 1] : "") + s : 1 === u && c > 0 && (s = t[c - 1] + s), a = Math.floor(a / 10)
      }
      return (A < 0 ? r : "") + s
    },
    M = e.createCounterText = function(A, e, t) {
      var r = t ? ". " : "",
        i = t ? "、" : "",
        n = t ? ", " : "";
      switch (e) {
        case l.LIST_STYLE_TYPE.DISC:
          return "•";
        case l.LIST_STYLE_TYPE.CIRCLE:
          return "◦";
        case l.LIST_STYLE_TYPE.SQUARE:
          return "◾";
        case l.LIST_STYLE_TYPE.DECIMAL_LEADING_ZERO:
          var o = p(A, 48, 57, !0, r);
          return o.length < 4 ? "0" + o : o;
        case l.LIST_STYLE_TYPE.CJK_DECIMAL:
          return C(A, "〇一二三四五六七八九", i);
        case l.LIST_STYLE_TYPE.LOWER_ROMAN:
          return w(A, 1, 3999, B, l.LIST_STYLE_TYPE.DECIMAL, r).toLowerCase();
        case l.LIST_STYLE_TYPE.UPPER_ROMAN:
          return w(A, 1, 3999, B, l.LIST_STYLE_TYPE.DECIMAL, r);
        case l.LIST_STYLE_TYPE.LOWER_GREEK:
          return p(A, 945, 969, !1, r);
        case l.LIST_STYLE_TYPE.LOWER_ALPHA:
          return p(A, 97, 122, !1, r);
        case l.LIST_STYLE_TYPE.UPPER_ALPHA:
          return p(A, 65, 90, !1, r);
        case l.LIST_STYLE_TYPE.ARABIC_INDIC:
          return p(A, 1632, 1641, !0, r);
        case l.LIST_STYLE_TYPE.ARMENIAN:
        case l.LIST_STYLE_TYPE.UPPER_ARMENIAN:
          return w(A, 1, 9999, g, l.LIST_STYLE_TYPE.DECIMAL, r);
        case l.LIST_STYLE_TYPE.LOWER_ARMENIAN:
          return w(A, 1, 9999, g, l.LIST_STYLE_TYPE.DECIMAL, r).toLowerCase();
        case l.LIST_STYLE_TYPE.BENGALI:
          return p(A, 2534, 2543, !0, r);
        case l.LIST_STYLE_TYPE.CAMBODIAN:
        case l.LIST_STYLE_TYPE.KHMER:
          return p(A, 6112, 6121, !0, r);
        case l.LIST_STYLE_TYPE.CJK_EARTHLY_BRANCH:
          return C(A, "子丑寅卯辰巳午未申酉戌亥", i);
        case l.LIST_STYLE_TYPE.CJK_HEAVENLY_STEM:
          return C(A, "甲乙丙丁戊己庚辛壬癸", i);
        case l.LIST_STYLE_TYPE.CJK_IDEOGRAPHIC:
        case l.LIST_STYLE_TYPE.TRAD_CHINESE_INFORMAL:
          return f(A, "零一二三四五六七八九", "十百千萬", "負", i, 14);
        case l.LIST_STYLE_TYPE.TRAD_CHINESE_FORMAL:
          return f(A, "零壹貳參肆伍陸柒捌玖", "拾佰仟萬", "負", i, 15);
        case l.LIST_STYLE_TYPE.SIMP_CHINESE_INFORMAL:
          return f(A, "零一二三四五六七八九", "十百千萬", "负", i, 14);
        case l.LIST_STYLE_TYPE.SIMP_CHINESE_FORMAL:
          return f(A, "零壹贰叁肆伍陆柒捌玖", "拾佰仟萬", "负", i, 15);
        case l.LIST_STYLE_TYPE.JAPANESE_INFORMAL:
          return f(A, "〇一二三四五六七八九", "十百千万", "マイナス", i, 0);
        case l.LIST_STYLE_TYPE.JAPANESE_FORMAL:
          return f(A, "零壱弐参四伍六七八九", "拾百千万", "マイナス", i, 7);
        case l.LIST_STYLE_TYPE.KOREAN_HANGUL_FORMAL:
          return f(A, "영일이삼사오육칠팔구", "십백천만", "마이너스 ", n, 7);
        case l.LIST_STYLE_TYPE.KOREAN_HANJA_INFORMAL:
          return f(A, "零一二三四五六七八九", "十百千萬", "마이너스 ", n, 0);
        case l.LIST_STYLE_TYPE.KOREAN_HANJA_FORMAL:
          return f(A, "零壹貳參四五六七八九", "拾百千", "마이너스 ", n, 7);
        case l.LIST_STYLE_TYPE.DEVANAGARI:
          return p(A, 2406, 2415, !0, r);
        case l.LIST_STYLE_TYPE.GEORGIAN:
          return w(A, 1, 19999, d, l.LIST_STYLE_TYPE.DECIMAL, r);
        case l.LIST_STYLE_TYPE.GUJARATI:
          return p(A, 2790, 2799, !0, r);
        case l.LIST_STYLE_TYPE.GURMUKHI:
          return p(A, 2662, 2671, !0, r);
        case l.LIST_STYLE_TYPE.HEBREW:
          return w(A, 1, 10999, h, l.LIST_STYLE_TYPE.DECIMAL, r);
        case l.LIST_STYLE_TYPE.HIRAGANA:
          return C(A, "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわゐゑをん");
        case l.LIST_STYLE_TYPE.HIRAGANA_IROHA:
          return C(A, "いろはにほへとちりぬるをわかよたれそつねならむうゐのおくやまけふこえてあさきゆめみしゑひもせす");
        case l.LIST_STYLE_TYPE.KANNADA:
          return p(A, 3302, 3311, !0, r);
        case l.LIST_STYLE_TYPE.KATAKANA:
          return C(A, "アイウエオカキクケコサシスセソタチツテトナニヌネノハヒフヘホマミムメモヤユヨラリルレロワヰヱヲン", i);
        case l.LIST_STYLE_TYPE.KATAKANA_IROHA:
          return C(A, "イロハニホヘトチリヌルヲワカヨタレソツネナラムウヰノオクヤマケフコエテアサキユメミシヱヒモセス", i);
        case l.LIST_STYLE_TYPE.LAO:
          return p(A, 3792, 3801, !0, r);
        case l.LIST_STYLE_TYPE.MONGOLIAN:
          return p(A, 6160, 6169, !0, r);
        case l.LIST_STYLE_TYPE.MYANMAR:
          return p(A, 4160, 4169, !0, r);
        case l.LIST_STYLE_TYPE.ORIYA:
          return p(A, 2918, 2927, !0, r);
        case l.LIST_STYLE_TYPE.PERSIAN:
          return p(A, 1776, 1785, !0, r);
        case l.LIST_STYLE_TYPE.TAMIL:
          return p(A, 3046, 3055, !0, r);
        case l.LIST_STYLE_TYPE.TELUGU:
          return p(A, 3174, 3183, !0, r);
        case l.LIST_STYLE_TYPE.THAI:
          return p(A, 3664, 3673, !0, r);
        case l.LIST_STYLE_TYPE.TIBETAN:
          return p(A, 3872, 3881, !0, r);
        case l.LIST_STYLE_TYPE.DECIMAL:
        default:
          return p(A, 48, 57, !0, r)
      }
    }
}, function(A, e, t) {
  "use strict";
  ...
  e.parseBorder = function(A) {
    return a.map(function(e) {
      var t = new i.default(A.getPropertyValue("border-" + e + "-color")),
  ...
  e.parseTextDecoration = function(A) {
    var e = l(A.textDecorationLine ? A.textDecorationLine : A.textDecoration);
    return null === e ? o.NONE : {
      textDecorationLine: e,
      textDecorationColor: A.textDecorationColor ? new i.default(A.textDecorationColor) : null,
  ...
  function r(A, e) {
    for (var t = 0; t < A.length; t++) {
      ...
      if (i) {
        ...
        for (; n < r.parts.length; n++) i.parts.push(c(r.parts[n], e))
      } else {
        for (var o = [], n = 0; n < r.parts.length; n++) o.push(c(r.parts[n], e));
        h[r.id] = {
          id: r.id,
          refs: 1,
          parts: o
  ...
  function i(A, e) {
    for (var t = [], r = {}, i = 0; i < A.length; i++) {
      ...
      r[o] ? r[o].parts.push(c) : t.push(r[o] = {
        id: o,
        parts: [c]
      })
    }
  ...
  function n(A, e) {
    ...
    var r = C[C.length - 1];
    if ("top" === A.insertAt) r ? r.nextSibling ? t.insertBefore(e, r.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), C.push(e);
    else {
  ...
  function c(A, e) {
    ...
    if (e.transform && A.css) {
      if (!(n = e.transform(A.css))) return function() {};
      A.css = n
    }
    if (e.singleton) {
      var l = p++;
      t = Q || (Q = a(e)), r = u.bind(null, t, l, !1), i = u.bind(null, t, l, !0)
    } else A.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = s(e), r = g.bind(null, t, e), i = function() {
      o(t), t.href && URL.revokeObjectURL(t.href)
    }) : (t = a(e), r = B.bind(null, t), i = function() {
      o(t)
    });
    return r(A),
      function(e) {
  ...
  function u(A, e, t, r) {
    var i = t ? "" : r.css;
    if (A.styleSheet) A.styleSheet.cssText = M(e, i);
    else {
  ...
  function g(A, e, t) {
    ...
    (e.convertToAbsoluteUrls || n) && (r = f(r)), i && (r += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(i)))) + " */");
    var o = new Blob([r], {
        type: "text/css"
      }),
      a = A.href;
  ...
  function i(A) {
    var e = /^#?([a-fA-F\d]{2})([a-fA-F\d]{2})([a-fA-F\d]{2})$/i.exec(A);
    return e ? {
      r: parseInt(e[1], 16),
      g: parseInt(e[2], 16),
      b: parseInt(e[3], 16)
    } : (e = /^#?([a-fA-F\d])([a-fA-F\d])([a-fA-F\d])$/i.exec(A), e ? {
  ...
  var c = t(4),
    ...
    B = function() {
      function A(e, t) {
        var i = this;
        r(this, A), this.callback = t, this.main = e, this.w = 180, this.h = 150;
        var n = this.w,
          o = this.h;
        ...
        var a = this.ctx.createLinearGradient(0, 0, n, 0);
        a.addColorStop(1 / 15, "#ff0000"), a.addColorStop(4 / 15, "#ffff00"), a.addColorStop(5 / 15, "#00ff00"), a.addColorStop(.6, "#00ffff"), a.addColorStop(.8, "#0000ff"), a.addColorStop(14 / 15, "#ff00ff"), this.ctx.fillStyle = a, this.ctx.fillRect(0, 0, n, o);
        var s = this.ctx.createLinearGradient(0, 0, 0, o);
        s.addColorStop(0, "rgba(0, 0, 0, 0)"), s.addColorStop(.99, "rgba(0, 0, 0, 1)"), s.addColorStop(1, "rgba(0, 0, 0, 1)"), this.ctx.fillStyle = s, this.ctx.fillRect(0, 0, n, o), this.closeButton.onclick = function() {
          i.close()
        }, this.pipetteButton.onclick = function() {
          i.wrapper.setAttribute("hidden", "true"), i.opened = !1, i.choosing = !0
        }, this.input.onkeyup = function() {
          i.setActiveColor(i.input.value, !0)
        }
      }
      return l(A, [{
        key: "open",
        value: function(A, e) {
          this.target = A.target, this.palleteColor = A.palleteColor, this.alpha = A.alpha, this.lightPosition = this.lightPosition || this.w - 1, this.drawLighter(), this.colorRegulator.style.left = this.lightPosition + "px", this.alphaRegulator.style.left = Math.round(this.alpha * this.w) + "px", this.regetColor(), this.wrapper.removeAttribute("hidden"), this.opened = !0, this.addCallback = e
        }
      }, {
        key: "close",
        value: function() {
        ...
        value: function(A) {
          var e = A.clientX - this.canvas.documentOffsetLeft,
            t = A.clientY - this.canvas.documentOffsetTop;
          e = e < 1 && 1 || e, t = t < 1 && 1 || t, e = e > this.w && this.w - 1 || e, t = t > this.h && this.h - 1 || t;
          var r = this.ctx.getImageData(e, t, 1, 1).data;
          this.palleteColor = a(r[0], r[1], r[2]), this.drawLighter(), this.regetColor()
        }
      }, {
        key: "regetColor",
        value: function() {
          var A = this.ctxLight.getImageData(this.lightPosition, 5, 1, 1).data;
          this.setActiveColor(a(A[0], A[1], A[2])), this.drawAlpher()
        }
      }, {
        key: "regetAlpha",
        value: function() {
          var A = this.ctxAlpha.getImageData(this.alphaPosition, 5, 1, 1).data;
          this.alpha = A[3] / 255, this.setActiveColor(this.color, !0)
        }
      }, {
        key: "getColorLightAtClick",
        value: function(A) {
          var e = A.clientX - this.canvasLight.documentOffsetLeft;
          e = e < 1 && 1 || e, e = e > this.w - 1 && this.w - 1 || e, this.lightPosition = e, this.colorRegulator.style.left = e + "px", this.regetColor()
        }
      }, {
        key: "getAlphaAtClick",
        value: function(A) {
          var e = A.clientX - this.canvasAlpha.documentOffsetLeft;
          e = e < 1 && 1 || e, e = e > this.w - 1 && this.w - 1 || e, this.alphaPosition = e, this.alphaRegulator.style.left = e + "px", this.regetAlpha()
        }
      }, {
        key: "handleKeyDown",
        value: function(A) {
          A.keyCode === u.KEYS.esc && this.close()
        }
      }, {
        key: "handleMouseDown",
        value: function(A) {
          return this.choosing && 2 !== A.button ? (this.choosingActive = !0, this.handleMouseMove(A), !0) : (this.choosing = !1, A.target === this.canvas && (this.selecting = !0, this.getPaletteColorAtPoint(A)), A.target !== this.canvasLight && A.target !== this.colorRegulator || (this.lightSelecting = !0, this.getColorLightAtClick(A)), A.target !== this.canvasAlpha && A.target !== this.alphaRegulator || (this.alphaSelecting = !0, this.getAlphaAtClick(A)), !1)
        }
      }, {
        key: "handleMouseMove",
        value: function(A) {
          if (this.opened) this.selecting && this.getPaletteColorAtPoint(A), this.lightSelecting && this.getColorLightAtClick(A), this.alphaSelecting && this.getAlphaAtClick(A);
          else if (this.choosingActive) {
            var e = this.main.getScale(),
              t = (A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft) * e;
            t = t < 1 && 1 || t, t = t > this.main.size.w - 1 && this.main.size.w - 1 || t;
            var r = (A.clientY - this.main.elTop() + this.main.scroller.scrollTop) * e;
            r = r < 1 && 1 || r, r = r > this.main.size.h - 1 && this.main.size.h - 1 || r;
            var i = this.main.ctx.getImageData(t, r, 1, 1).data,
              o = a(i[0], i[1], i[2]);
            this.callback({
              alphaColor: n(o, 1),
        ...
        value: function(A, e) {
          try {
            this.input.style.color = s(A)
          } catch (A) {
            return
          }
          this.input.style["background-color"] = A, void 0 === e && (this.input.value = A), this.color = A, this.alphaColor = n(A, this.alpha), void 0 !== this.callback && this.opened && this.callback({
  ...
  (function(e) {
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(A) {
      ...
      o = "function" == typeof Symbol && "symbol" === i(Symbol.iterator) ? function(A) {
        return void 0 === A ? "undefined" : i(A)
      } : function(A) {
        return A && "function" == typeof Symbol && A.constructor === Symbol && A !== Symbol.prototype ? "symbol" : void 0 === A ? "undefined" : i(A)
      },
      a = t(35),
      s = r(a),
      l = t(27),
      ...
      B = t(2),
      g = function(A, t) {
        "object" === ("undefined" == typeof console ? "undefined" : o(console)) && "function" == typeof console.log && console.log("html2canvas $npm_package_version");
        var r = t || {},
          i = new c.default("boolean" != typeof r.logging || r.logging);
        "production" !== e.env.NODE_ENV && "function" == typeof r.onrendered && i.error("onrendered option is deprecated, html2canvas returns a Promise with the canvas as the value");
        var a = A.ownerDocument;
        if (!a) return Promise.reject("Provided element is not within a Document");
        var l = a.defaultView,
          g = l.pageXOffset,
          h = l.pageYOffset,
          d = "HTML" === A.tagName || "BODY" === A.tagName,
          w = d ? (0, B.parseDocumentSize)(a) : (0, B.parseBounds)(A, g, h),
          Q = w.width,
          p = w.height,
          C = w.left,
          f = w.top,
          ...
          U = (0, u.renderElement)(A, n({}, M, r), i);
        return "production" !== e.env.NODE_ENV ? U.catch(function(A) {
          throw i.error(A), A
        }) : U
      };
    g.CanvasRenderer = s.default, A.exports = g
  }).call(e, t(0))
}, function(A, e, t) {
  "use strict";
  A.exports = function(A) {
  ...
  (function(A) {
    ...
    e.FontMetrics = function() {
      function e(A) {
        r(this, e), this._data = {}, this._document = A
      }
      return i(e, [{
        key: "_parseMetrics",
        value: function(e) {
  ...
  var i = t(10),
    ...
    d = r(h),
    w = (t(2), t(29), t(7)),
    Q = (e.INPUT_COLOR = new g.default([42, 42, 42]), new g.default([165, 165, 165])),
    p = new g.default([222, 222, 222]),
    C = {
      borderWidth: 1,
      borderColor: Q,
      borderStyle: a.BORDER_STYLE.SOLID
    },
    f = (e.INPUT_BORDERS = [C, C, C, C], e.INPUT_BACKGROUND = {
      backgroundColor: p,
      backgroundImage: [],
    ...
    E = (e.getInputBorderRadius = function(A) {
      return "radio" === A.type ? U : T
    }, e.inlineInputElement = function(A, e) {
      if ("radio" === A.type || "checkbox" === A.type) {
        if (A.checked) {
          var t = Math.min(e.bounds.width, e.bounds.height);
          e.childNodes.push("checkbox" === A.type ? [new u.default(e.bounds.left + .39363 * t, e.bounds.top + .79 * t), new u.default(e.bounds.left + .16 * t, e.bounds.top + .5549 * t), new u.default(e.bounds.left + .27347 * t, e.bounds.top + .44071 * t), new u.default(e.bounds.left + .39694 * t, e.bounds.top + .5649 * t), new u.default(e.bounds.left + .72983 * t, e.bounds.top + .23 * t), new u.default(e.bounds.left + .84 * t, e.bounds.top + .34085 * t), new u.default(e.bounds.left + .39363 * t, e.bounds.top + .79 * t)] : new l.default(e.bounds.left + t / 4, e.bounds.top + t / 4, t / 4))
        }
      } else E(D(A), A, e, !1)
      ...
      if (A.length > 0 && i) {
        ...
        (0, w.copyCSSStyles)(e.ownerDocument.defaultView.getComputedStyle(e, null), o), o.style.position = "absolute", o.style.left = t.bounds.left + "px", o.style.top = t.bounds.top + "px", r || (o.style.whiteSpace = "nowrap");
        var a = e.ownerDocument.createTextNode(A);
        o.appendChild(a), i.appendChild(o), t.childNodes.push(n.default.fromTextNode(a, t)), i.removeChild(o)
      }
    }),
    D = function(A) {
  ...
  var i = function() {
    ...
    n = function() {
      function A(e, t, i) {
        r(this, A), this.enabled = e, this.start = i || Date.now(), this.id = t
      }
      return i(A, [{
        key: "child",
        value: function(e) {
  ...
  (function(A) {
    ...
    e.Proxy = function(e, t) {
      ...
      return new Promise(function(n, o) {
        var a = i.default.SUPPORT_CORS_XHR && i.default.SUPPORT_RESPONSE_TYPE ? "blob" : "text",
          s = i.default.SUPPORT_CORS_XHR ? new XMLHttpRequest : new XDomainRequest;
        if (s.onload = function() {
            ...
            else o("production" !== A.env.NODE_ENV ? "Failed to proxy resource " + e.substring(0, 256) + " with status code " + s.status : "");
            else n(s.responseText)
          }, s.onerror = o, s.open("GET", r + "?url=" + encodeURIComponent(e) + "&responseType=" + a), "text" !== a && s instanceof XMLHttpRequest && (s.responseType = a), t.imageTimeout) {
          var l = t.imageTimeout;
          s.timeout = l, s.ontimeout = function() {
            return o("production" !== A.env.NODE_ENV ? "Timed out (" + l + "ms) proxying " + e.substring(0, 256) : "")
          }
        }
        s.send()
      })
  ...
  var i = t(2),
    ...
    s = t(30),
    l = e.TextBounds = function A(e, t) {
      r(this, A), this.text = e, this.bounds = t
    },
    c = (e.parseTextBounds = function(A, e, t) {
      for (var r = 0 !== e.style.letterSpacing, i = r ? (0, s.toCodePoints)(A).map(function(A) {
          return (0, s.fromCodePoint)(A)
        }) : (0, s.breakWords)(A, e), o = i.length, B = t.parentNode ? t.parentNode.ownerDocument.defaultView : null, g = B ? B.pageXOffset : 0, h = B ? B.pageYOffset : 0, d = [], w = 0, Q = 0; Q < o; Q++) {
        var p = i[Q];
        if (e.style.textDecoration !== n.TEXT_DECORATION.NONE || p.trim().length > 0)
          if (a.default.SUPPORT_RANGE_BOUNDS) d.push(new l(p, u(t, w, p.length, g, h)));
          else {
            var C = t.splitText(p.length);
            d.push(new l(p, c(t, g, h))), t = C
          }
        else a.default.SUPPORT_RANGE_BOUNDS || (t = t.splitText(p.length));
        w += p.length
      }
      return d
    }, function(A, e, t) {
      ...
      if (n) {
        n.replaceChild(r, A);
        var o = (0, i.parseBounds)(r, e, t);
        return r.firstChild && n.replaceChild(r.firstChild, r), o
      }
      return new i.Bounds(0, 0, 0, 0)
    }),
    u = function(A, e, t, r, n) {
      var o = A.ownerDocument.createRange();
      return o.setStart(A, e), o.setEnd(A, e + t), i.Bounds.fromClientRect(o.getBoundingClientRect(), r, n)
    }
}, function(A, e, t) {
  "use strict";
  Object.defineProperty(e, "__esModule", {
  ...
  e.breakWords = function(A, e) {
    for (var t = (0, r.LineBreaker)(A, {
      ...
      }), i = [], o = void 0; !(o = t.next()).done;) i.push(o.value.slice());
    return i
  }
}, function(A, e, t) {
  "use strict";
  ...
  e.parsePadding = function(A) {
    return n.map(function(e) {
      return new i.default(A.getPropertyValue("padding-" + e))
    })
  }
}, function(A, e, t) {
  "use strict";
  ...
  var i = function() {
    ...
    s = function() {
      ...
      return i(A, [{
        ...
        key: "rectangle",
        value: function(A, e, t, r, i) {
          this.ctx.fillStyle = i.toString(), this.ctx.fillRect(A, e, t, r)
        }
      }, {
        ...
        value: function(A, e) {
          var t = this,
            r = A.left + e.center.x,
            i = A.top + e.center.y,
            n = this.ctx.createRadialGradient(r, i, 0, r, i, e.radius.x);
          if (n)
            if (a(e, n), this.ctx.fillStyle = n, e.radius.x !== e.radius.y) {
              var o = A.left + .5 * A.width,
                s = A.top + .5 * A.height,
                l = e.radius.y / e.radius.x,
                c = 1 / l;
              this.transform(o, s, [1, 0, 0, l, 0, 0], function() {
        ...
        key: "renderRepeat",
        value: function(A, e, t, r, i) {
          this.path(A), this.ctx.fillStyle = this.ctx.createPattern(this.resizeImage(e, t), "repeat"), this.ctx.translate(r, i), this.ctx.fill(), this.ctx.translate(-r, -i)
        }
      }, {
        key: "renderTextNode",
        value: function(A, e, t, r, i) {
          ...
          this.ctx.font = [t.fontStyle, t.fontVariant, t.fontWeight, t.fontSize, t.fontFamily].join(" "), A.forEach(function(A) {
            if (n.ctx.fillStyle = e.toString(), i && A.text.trim().length ? i.slice(0).reverse().forEach(function(e) {
                n.ctx.shadowColor = e.color.toString(), n.ctx.shadowOffsetX = e.offsetX * n.options.scale, n.ctx.shadowOffsetY = e.offsetY * n.options.scale, n.ctx.shadowBlur = e.blur, n.ctx.fillText(A.text, A.bounds.left, A.bounds.top + A.bounds.height)
              }) : n.ctx.fillText(A.text, A.bounds.left, A.bounds.top + A.bounds.height), null !== r) {
              var a = r.textDecorationColor || e;
              r.textDecorationLine.forEach(function(e) {
                switch (e) {
                  case o.TEXT_DECORATION_LINE.UNDERLINE:
                    var r = n.options.fontMetrics.getMetrics(t),
                      i = r.baseline;
                    n.rectangle(A.bounds.left, Math.round(A.bounds.top + A.bounds.height - i), A.bounds.width, 1, a);
                    break;
                  case o.TEXT_DECORATION_LINE.OVERLINE:
                    n.rectangle(A.bounds.left, Math.round(A.bounds.top), A.bounds.width, 1, a);
                    break;
                  case o.TEXT_DECORATION_LINE.LINE_THROUGH:
                    var s = n.options.fontMetrics.getMetrics(t),
                      l = s.middle;
                    n.rectangle(A.bounds.left, Math.ceil(A.bounds.top + l), A.bounds.width, 1, a)
                }
              })
            }
          })
  ...
  e.default = n;
  var o = e.createForeignObjectSVG = function(A, e, t, r, i) {
      var n = "http://www.w3.org/2000/svg",
        o = document.createElementNS(n, "svg"),
        a = document.createElementNS(n, "foreignObject");
      return o.setAttributeNS(null, "width", A), o.setAttributeNS(null, "height", e), a.setAttributeNS(null, "width", "100%"), a.setAttributeNS(null, "height", "100%"), a.setAttributeNS(null, "x", t), a.setAttributeNS(null, "y", r), a.setAttributeNS(null, "externalResourcesRequired", "true"), o.appendChild(a), a.appendChild(i), o
    },
    ...
    o = function() {
      ...
      return i(A, [{
        ...
        value: function(e) {
          var t = this,
            r = function() {
              var A = document.getElementById(t.main.activeTool.controls[e].id).value;
              t.main.textTool.setFontSize(A), (0, n.setParam)("defaultFontSize", A)
            },
            i = function() {
              return t.main.textTool.fontSize
            };
          return this.main.params.availableFontSizes ? A.buildDropDownControl("fontSize", r, i, this.main.params.availableFontSizes) : A.buildInputControl("fontSize", r, i, 1, 200)
        }
      }, {
        ...
        value: function(e) {
          var t = this,
            r = function() {
              var A = document.getElementById(t.main.activeTool.controls[e].id).value;
              t.main.primitiveTool.setEraserWidth(A), (0, n.setParam)("defaultEraserWidth", A)
            },
            i = function() {
              return t.main.primitiveTool.eraserWidth
            };
          return this.main.params.availableEraserWidths ? A.buildDropDownControl("eraserWidth", r, i, this.main.params.availableEraserWidths) : A.buildInputControl("eraserWidth", r, i, 1, 99)
        }
      }, {
        ...
        value: function(e) {
          var t = this,
            r = function() {
              var A = document.getElementById(t.main.activeTool.controls[e].id).value;
              t.main.primitiveTool.setLineWidth(A), (0, n.setParam)("defaultLineWidth", A)
            },
            i = function() {
              return t.main.primitiveTool.lineWidth
            };
          return this.main.params.availableLineWidths ? A.buildDropDownControl("lineWidth", r, i, this.main.params.availableLineWidths) : A.buildInputControl("lineWidth", r, i, 1, 99)
        }
      }], [{
  ...
  var i = function() {
    ...
    a = function() {
          ...
          extend_down: {
            handle: function(A) {
              ...
              var t = e.main.size.h,
                r = e.main.size.w,
                i = t + A.naturalHeight,
                n = Math.max(r, A.naturalWidth),
                o = e.ctx.getImageData(0, 0, e.main.size.w, e.main.size.h);
              if (e.main.resize(n, i), e.main.clearBackground(), e.ctx.putImageData(o, 0, 0), e.main.adjustSizeFull(), A.naturalWidth < r) {
                var a = Math.round((r - A.naturalWidth) / 2);
                e.main.select.placeAt(a, t, a, 0, A)
              } else e.main.select.placeAt(0, t, 0, 0, A);
          ...
          extend_right: {
            handle: function(A) {
              ...
              var t = e.main.size.h,
                r = e.main.size.w,
                i = r + A.naturalWidth,
                n = Math.max(t, A.naturalHeight),
                o = e.ctx.getImageData(0, 0, e.main.size.w, e.main.size.h);
              if (e.main.resize(i, n), e.main.clearBackground(), e.ctx.putImageData(o, 0, 0), e.main.adjustSizeFull(), A.naturalHeight < t) {
                var a = Math.round((t - A.naturalHeight) / 2);
                e.main.select.placeAt(r, a, 0, a, A)
              } else e.main.select.placeAt(r, 0, 0, 0, A);
              e.worklog.captureState()
            }
          },
          over: {
            handle: function(A) {
              ...
              var t = e.main.size.h,
                r = e.main.size.w;
              if (A.naturalHeight <= t && A.naturalWidth <= r) e.main.select.placeAt(0, 0, r - A.naturalWidth, t - A.naturalHeight, A);
              else if (A.naturalWidth / A.naturalHeight > r / t) {
                var i = r * (A.naturalHeight / A.naturalWidth);
                e.main.select.placeAt(0, 0, 0, t - i, A)
              } else {
                var n = t * (A.naturalWidth / A.naturalHeight);
                e.main.select.placeAt(0, 0, r - n, 0, A)
              }
              e.worklog.captureState()
            }
          }
      ...
      return i(A, [{
        ...
        value: function(A) {
          var e = this;
          this.CLIP_DATA_MARKER = "painterro-image-data", this.ctx = A.ctx, this.main = A, this.worklog = A.worklog, this.selector = A.wrapper.querySelector(".ptro-paster-select-wrapper"), this.cancelChoosing(), this.img = null, Object.keys(this.pasteOptions).forEach(function(A) {
            var t = e.pasteOptions[A];
            e.main.doc.getElementById(t.id).onclick = function() {
              e.loading ? e.doLater = t.handle : t.handle(e.img), e.cancelChoosing()
            }
        ...
        key: "insert",
        value: function(A, e, t, r) {
          this.main.ctx.drawImage(this.tmpImg, A, e, t, r), this.main.worklog.reCaptureState()
        }
      }, {
        key: "cancelChoosing",
        value: function() {
        ...
        key: "loaded",
        value: function(A) {
          this.img = A, this.loading = !1, this.doLater && (this.doLater(A), this.doLater = null)
        }
      }, {
        key: "handleOpen",
        value: function(A) {
          ...
          var t = function(A) {
            var t = new Image,
              r = e.main.worklog.clean;
            t.onload = function() {
              r ? e.main.fitImage(t) : e.loaded(t), e.finishLoading()
            }, t.src = A, r || (e.selector.removeAttribute("hidden"), e.waitChoice = !0)
          };
          0 !== A.indexOf("data") ? (0, o.imgToDataURL)(A, function(A) {
            t(A)
          }) : t(A)
        }
      }, {
        key: "handleKeyDown",
        value: function(A) {
          if (this.waitChoice && A.keyCode === o.KEYS.esc && this.cancelChoosing(), !this.waitChoice && !this.main.select.imagePlaced && this.main.select.shown && A.keyCode === o.KEYS.c && (A.ctrlKey || A.metaKey)) {
            var e = this.main.select.area,
              t = e.bottoml[0] - e.topl[0],
              r = e.bottoml[1] - e.topl[1],
              i = this.main.doc.createElement("canvas");
            i.width = t, i.height = r;
            i.getContext("2d").drawImage(this.main.canvas, -e.topl[0], -e.topl[1]), (0, o.copyToClipboard)(this.CLIP_DATA_MARKER);
            try {
              localStorage.setItem(this.CLIP_DATA_MARKER, i.toDataURL())
            } catch (A) {
              console.error("Unable save image to localstorage: " + A)
            }
          }
        }
      }, {
        ...
        value: function() {
          this.loading = !0;
          var A = this.main.doc.getElementById(this.main.toolByName.open.buttonId),
            e = this.main.doc.querySelector("#" + this.main.toolByName.open.buttonId + " > i");
          A && A.setAttribute("disabled", "true"), e && (e.className = "ptro-icon ptro-icon-loading ptro-spinning")
        }
      }, {
        key: "finishLoading",
        value: function() {
          var A = this.main.doc.getElementById(this.main.toolByName.open.buttonId),
            e = this.main.doc.querySelector("#" + this.main.toolByName.open.buttonId + " > i");
          A && A.removeAttribute("disabled"), e && (e.className = "ptro-icon ptro-icon-open")
        }
      }, {
        key: "html",
        value: function() {
          var A = this,
            e = "";
          return Object.keys(this.pasteOptions).forEach(function(t) {
            var r = A.pasteOptions[t];
            r.id = (0, o.genId)(), e += '<button type="button" id="' + r.id + '" class="ptro-selector-btn ptro-color-control"><div><i class="ptro-icon ptro-icon-paste_' + t + '"></i></div><div>' + (0, n.tr)("pasteOptions." + t) + "</div></button>"
          }), '<div class="ptro-paster-select-wrapper" hidden><div class="ptro-paster-select ptro-v-middle"><div class="ptro-in ptro-v-middle-in"><div class="ptro-paste-label">' + (0, n.tr)("pasteOptions.how_to_paste") + "</div>" + e + "</div></div></div>"
        }
      }]), A
    }();
  e.default = a
  ...
  var i = function() {
    ...
    n = function() {
      function A(e) {
        r(this, A), this.ctx = e.ctx, this.el = e.toolContainer, this.main = e, this.helperCanvas = document.createElement("canvas"), this.canvas = e.canvas
      }
      return i(A, [{
        key: "activate",
        value: function(A) {
          this.type = A, this.state = {}, this.ctx.lineJoin = "line" === A || "brush" === A || "eraser" === A ? "round" : "miter"
        }
      }, {
        key: "setLineWidth",
        value: function(A) {
        ...
        value: function(A) {
          ...
          if (this.ctx.lineCap = "round", "ptro-crp-el" === e || "ptro-zoomer" === e)
            if (this.tmpData = this.ctx.getImageData(0, 0, this.main.size.w, this.main.size.h), "brush" === this.type || "eraser" === this.type) {
              ...
              var r = [A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft, A.clientY - this.main.elTop() + this.main.scroller.scrollTop],
                i = {
                  x: r[0] * t,
                  y: r[1] * t
                };
              this.points = [i], this.drawBrushPath()
            } else this.state.cornerMarked = !0, this.centerCord = [A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft, A.clientY - this.main.elTop() + this.main.scroller.scrollTop], this.centerCord = [this.centerCord[0] * t, this.centerCord[1] * t]
        }
      }, {
        key: "drawBrushPath",
        value: function() {
          ...
          for (var n = 1 !== this.main.currentBackgroundAlpha, o = 1; o <= (i && n ? 2 : 1); o += 1)
            if (i && (this.ctx.globalCompositeOperation = 1 === o && n ? "destination-out" : r, t = 1 === o && n ? "rgba(0,0,0,1)" : this.main.currentBackground), 1 === e.length) this.ctx.beginPath(), this.ctx.lineWidth = 0, this.ctx.fillStyle = t, this.ctx.arc(this.points[0].x, this.points[0].y, this.lineWidth / 2, this.lineWidth / 2, 0, 2 * Math.PI), this.ctx.fill(), this.ctx.closePath();
            else {
              ...
              e.slice(1).forEach(function(e) {
                A.ctx.lineTo(e.x, e.y), a = e
              }), a && this.ctx.moveTo(a.x, a.y), this.ctx.stroke(), this.ctx.closePath()
        ...
        value: function(A) {
          if (this.state.cornerMarked) {
            this.ctx.putImageData(this.tmpData, 0, 0), this.curCord = [A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft, A.clientY - this.main.elTop() + this.main.scroller.scrollTop];
            var e = this.main.getScale();
            if (this.curCord = [this.curCord[0] * e, this.curCord[1] * e], "brush" === this.type || "eraser" === this.type) {
              var t = {
                x: this.curCord[0],
                y: this.curCord[1]
              };
              this.points.push(t), this.drawBrushPath()
            } else if ("line" === this.type) {
              if (A.ctrlKey || A.shiftKey) {
                var r = 180 * Math.atan(-(this.curCord[1] - this.centerCord[1]) / (this.curCord[0] - this.centerCord[0])) / Math.PI;
                if (Math.abs(r) < 22.5) this.curCord[1] = this.centerCord[1];
                else if (Math.abs(r) > 67.5) this.curCord[0] = this.centerCord[0];
                else {
              ...
              this.ctx.beginPath(), this.ctx.moveTo(this.centerCord[0], this.centerCord[1]), this.ctx.lineTo(this.curCord[0], this.curCord[1]), this.ctx.closePath(), this.ctx.stroke()
            } else if ("rect" === this.type) {
              this.ctx.beginPath();
              var n = [this.centerCord[0], this.centerCord[1]],
                o = this.curCord[0] - this.centerCord[0],
                a = this.curCord[1] - this.centerCord[1];
              if (A.ctrlKey || A.shiftKey) {
                var s = Math.min(Math.abs(o), Math.abs(a));
                o = s * Math.sign(o), a = s * Math.sign(a)
              }
              var l = Math.floor(this.lineWidth / 2),
                c = this.lineWidth % 2;
              this.ctx.rect(n[0] + l, n[1] + l, o - this.lineWidth + c, a - this.lineWidth + c), this.ctx.fill(), this.ctx.strokeRect(n[0], n[1], o, a), this.ctx.closePath()
            } else if ("ellipse" === this.type) {
              this.ctx.beginPath();
              var u = this.centerCord[0],
                B = this.centerCord[1],
                g = this.curCord[0] - u,
                h = this.curCord[1] - B;
              if (A.ctrlKey || A.shiftKey) {
                var d = Math.min(Math.abs(g), Math.abs(h));
                g = d * Math.sign(g), h = d * Math.sign(h)
              }
              var w = Math.abs(g),
                Q = Math.abs(h),
                p = Math.min(u, u + g),
              ...
              var f = 1,
                ...
                N = w / 2,
                I = Q / 2;
              w > Q ? (M = w / Q, U = N) : (f = Q / w, U = I), this.ctx.scale(1 / f, 1 / M), this.ctx.arc((p + N) * f, (C + I) * M, U, 0, 2 * Math.PI), this.ctx.restore(), this.ctx.fill(), this.ctx.stroke(), this.ctx.beginPath()
            }
          }
        }
      }, {
  ...
  var i = function() {
    ...
    o = function() {
      function A(e, t) {
        r(this, A), this.main = e, this.canvas = e.canvas, this.wrapper = e.wrapper, this.ctx = e.ctx, this.areaionCallback = t, this.shown = !1, this.area = {
          el: e.toolContainer,
          rect: document.querySelector("#" + e.id + " .ptro-crp-rect")
        }, this.imagePlaced = !1, this.pixelizePixelSize = e.params.pixelizePixelSize
      }
      return i(A, [{
        key: "activate",
        value: function() {
        ...
        key: "doCrop",
        value: function() {
          var A = this.ctx.getImageData(0, 0, this.main.size.w, this.main.size.h);
          this.main.resize(this.area.bottoml[0] - this.area.topl[0], this.area.bottoml[1] - this.area.topl[1]), this.main.ctx.putImageData(A, -this.area.topl[0], -this.area.topl[1]), this.main.adjustSizeFull(), this.main.worklog.captureState()
        }
      }, {
        key: "doPixelize",
        value: function() {
          var A = this.area.topl,
            e = [this.area.bottoml[0] - this.area.topl[0], this.area.bottoml[1] - this.area.topl[1]];
          "%" === this.pixelizePixelSize.slice(-1) ? this.pixelSize = Math.min(e[0], e[1]) / (100 / this.pixelizePixelSize.slice(0, -1)) : "px" === this.pixelizePixelSize.slice(-2).toLowerCase() ? this.pixelSize = this.pixelizePixelSize.slice(0, -2) : this.pixelSize = this.pixelizePixelSize, this.pixelSize < 2 && (this.pixelSize = 2);
          for (var t = [], r = [e[0] / this.pixelSize, e[1] / this.pixelSize], i = 0; i < r[0]; i += 1) {
            for (var n = [], o = 0; o < r[1]; o += 1) n.push([0, 0, 0, 0, 0]);
            t.push(n)
          }
          for (var a = this.ctx.getImageData(A[0], A[1], e[0], e[1]), s = 0; s < e[0]; s += 1)
            for (var l = 0; l < e[1]; l += 1) {
              var c = Math.floor(s / this.pixelSize),
                u = Math.floor(l / this.pixelSize),
                B = 4 * (l * e[0] + s);
              t[c][u][0] += a.data[B], t[c][u][1] += a.data[B + 1], t[c][u][2] += a.data[B + 2], t[c][u][3] += a.data[B + 3], t[c][u][4] += 1
            }
          for (var g = 0; g < r[0]; g += 1)
            for (var h = 0; h < r[1]; h += 1) {
              var d = t[g][h][4];
              this.ctx.fillStyle = "rgba(\n" + Math.round(t[g][h][0] / d) + ", \n" + Math.round(t[g][h][1] / d) + ", \n" + Math.round(t[g][h][2] / d) + ", \n" + Math.round(t[g][h][3] / d) + ")";
              var w = A[0] + g * this.pixelSize,
                Q = A[1] + h * this.pixelSize;
              this.ctx.fillRect(w, Q, this.pixelSize, this.pixelSize)
            }
        ...
        key: "selectAll",
        value: function() {
          this.setLeft(0), this.setRight(0), this.setBottom(0), this.setTop(0), this.show(), this.reCalcCropperCords(), this.area.activated && this.areaionCallback(this.area.rect.clientWidth > 0 && this.area.rect.clientHeight > 0)
        }
      }, {
        key: "getScale",
        value: function() {
        ...
        value: function() {
          var A = this.getScale();
          this.area.topl = [Math.round((this.rectLeft() - this.main.elLeft()) / A), Math.round((this.rectTop() - this.main.elTop()) / A)], this.area.bottoml = [Math.round(this.area.topl[0] + (this.area.rect.clientWidth + 2) / A), Math.round(this.area.topl[1] + (this.area.rect.clientHeight + 2) / A)]
        }
      }, {
        key: "adjustPosition",
        value: function() {
          if (this.shown) {
            var A = this.getScale();
            this.setLeft(this.area.topl[0] * A), this.setTop(this.area.topl[1] * A), this.setRight(0), this.setRight(this.canvas.clientWidth - this.area.bottoml[0] * A), this.setBottom(this.canvas.clientHeight - this.area.bottoml[1] * A)
          }
        }
      }, {
        key: "placeAt",
        value: function(A, e, t, r, i) {
          this.main.closeActiveTool(!0), this.main.setActiveTool(this.main.toolByName.select);
          var n = this.getScale();
          this.setLeft(A * n), this.setTop(e * n), this.setRight(t * n), this.setBottom(r * n);
          var o = document.createElement("canvas");
          o.width = i.naturalWidth, o.height = i.naturalHeight;
          var a = o.getContext("2d");
          a.drawImage(i, 0, 0), this.placedData = o.toDataURL("image/png");
          var s = 1e3 / Math.max(i.naturalWidth, i.naturalHeight);
          s >= 1 ? this.placedDataLow = this.placedData : (o.width = i.naturalWidth * s, o.height = i.naturalHeight * s, a.scale(s, s), a.drawImage(i, 0, 0), this.placedDataLow = o.toDataURL("image/png")), this.main.select.area.rect.style["background-image"] = "url(" + this.placedData + ")", this.show(), this.reCalcCropperCords(), this.imagePlaced = !0, this.placedRatio = i.naturalWidth / i.naturalHeight
        }
      }, {
        key: "finishPlacing",
        value: function() {
          this.imagePlaced = !1, this.main.select.area.rect.style["background-image"] = "none", this.main.inserter.insert(this.area.topl[0], this.area.topl[1], this.area.bottoml[0] - this.area.topl[0], this.area.bottoml[1] - this.area.topl[1])
        }
      }, {
        key: "cancelPlacing",
        value: function() {
        ...
        key: "handleKeyDown",
        value: function(A) {
          this.main.inserter.handleKeyDown(A), this.shown && this.imagePlaced ? A.keyCode === n.KEYS.enter ? this.finishPlacing() : A.keyCode === n.KEYS.esc && this.cancelPlacing() : this.shown && A.keyCode === n.KEYS.del ? this.doClearArea() : A.keyCode === n.KEYS.a && A.ctrlKey ? (this.selectAll(), event.preventDefault()) : A.keyCode === n.KEYS.esc && this.shown && this.hide()
        }
      }, {
        key: "handleMouseDown",
        value: function(A) {
          var e = this,
            t = A.target.classList[0],
            r = {
              "ptro-crp-el": function() {
                if (e.area.activated) {
                  e.imagePlaced && e.finishPlacing();
                  var t = A.clientX - e.main.elLeft() + e.main.scroller.scrollLeft,
                    r = A.clientY - e.main.elTop() + e.main.scroller.scrollTop;
                  e.setLeft(t), e.setTop(r), e.setRight(e.area.el.clientWidth - t), e.setBottom(e.area.el.clientHeight - r), e.reCalcCropperCords(), e.area.resizingB = !0, e.area.resizingR = !0, e.hide()
                }
              },
              "ptro-crp-rect": function() {
                e.area.moving = !0, e.area.xHandle = A.clientX - e.rectLeft() + e.main.scroller.scrollLeft, e.area.yHandle = A.clientY - e.rectTop() + e.main.scroller.scrollTop
              },
          ...
          t in r && (r[t](), this.imagePlaced && (this.main.select.area.rect.style["background-image"] = "url(" + this.placedDataLow + ")"))
        }
      }, {
        key: "setLeft",
        value: function(A) {
          this.left = A, this.area.rect.style.left = A + "px"
        }
      }, {
        key: "setRight",
        value: function(A) {
          this.right = A, this.area.rect.style.right = A + "px"
        }
      }, {
        key: "setTop",
        value: function(A) {
          this.top = A, this.area.rect.style.top = A + "px"
        }
      }, {
        key: "setBottom",
        value: function(A) {
          this.bottom = A, this.area.rect.style.bottom = A + "px"
        }
      }, {
        key: "handleMouseMove",
        value: function(A) {
          if (this.area.activated)
            if (this.area.moving) {
              var e = A.clientX - this.main.elLeft() - this.area.xHandle + this.main.scroller.scrollLeft;
              e < 0 ? e = 0 : e + this.area.rect.clientWidth > this.area.el.clientWidth - 2 && (e = this.area.el.clientWidth - this.area.rect.clientWidth - 2);
              var t = e - this.left;
              this.setLeft(e), this.setRight(this.right - t);
              var r = A.clientY - this.main.elTop() - this.area.yHandle + this.main.scroller.scrollTop;
              r < 0 ? r = 0 : r + this.area.rect.clientHeight > this.area.el.clientHeight - 2 && (r = this.area.el.clientHeight - this.area.rect.clientHeight - 2);
              var i = r - this.top;
              this.setTop(r), this.setBottom(this.bottom - i), this.reCalcCropperCords()
            } else {
              var o = !1;
              if (this.area.resizingL) {
                o = !0;
                var a = this.fixCropperLeft(A.clientX + this.main.scroller.scrollLeft);
                this.setLeft(a - this.main.elLeft()), this.reCalcCropperCords()
              }
              if (this.area.resizingR) {
                o = !0;
                var s = this.fixCropperRight(A.clientX + this.main.scroller.scrollLeft);
                this.setRight(this.area.el.clientWidth + this.main.elLeft() - s), this.reCalcCropperCords()
              }
              if (this.area.resizingT) {
                o = !0;
                var l = this.fixCropperTop(A.clientY + this.main.scroller.scrollTop);
                this.setTop(l - this.main.elTop()), this.reCalcCropperCords()
              }
              if (this.area.resizingB) {
                o = !0;
                var c = this.fixCropperBottom(A.clientY + this.main.scroller.scrollTop);
                this.setBottom(this.area.el.clientHeight + this.main.elTop() - c), this.reCalcCropperCords()
              }!this.imagePlaced || A.ctrlKey || A.shiftKey || (this.area.resizingT && (this.area.resizingL ? this.leftKeepRatio() : this.rightKeepRatio(), this.topKeepRatio(), this.reCalcCropperCords()), this.area.resizingB && (this.area.resizingL ? this.leftKeepRatio() : this.rightKeepRatio(), this.bottomKeepRatio(), this.reCalcCropperCords()), this.area.resizingL && (this.area.resizingT ? this.topKeepRatio() : this.bottomKeepRatio(), this.leftKeepRatio(), this.reCalcCropperCords()), this.area.resizingR && (this.area.resizingT ? this.topKeepRatio() : this.bottomKeepRatio(), this.rightKeepRatio(), this.reCalcCropperCords())), o && !this.shown && this.show(), o && (0, n.clearSelection)()
            }
        }
      }, {
        key: "leftKeepRatio",
        value: function() {
          var A = this.area.rect.clientHeight * this.placedRatio,
            e = this.main.elLeft() + (this.area.el.clientWidth - this.right - A - 2),
            t = this.fixCropperLeft(e);
          this.setLeft(t - this.main.elLeft())
        }
      }, {
        key: "topKeepRatio",
        value: function() {
          var A = this.area.rect.clientWidth / this.placedRatio,
            e = this.fixCropperTop(this.main.elTop() + (this.area.el.clientHeight - this.bottom - A - 2));
        ...
        value: function() {
          var A = this.area.rect.clientWidth / this.placedRatio,
            e = this.fixCropperBottom(this.main.elTop() + this.top + A + 2);
        ...
        value: function() {
          var A = this.area.rect.clientHeight * this.placedRatio,
            e = this.fixCropperRight(this.main.elLeft() + this.left + A + 2);
        ...
        key: "handleMouseUp",
        value: function() {
          this.area.activated && this.areaionCallback(this.area.rect.clientWidth > 0 && this.area.rect.clientHeight > 0), this.area.moving = !1, this.area.resizingT = !1, this.area.resizingR = !1, this.area.resizingB = !1, this.area.resizingL = !1, this.imagePlaced && (this.main.select.area.rect.style["background-image"] = "url(" + this.placedData + ")")
        }
      }, {
        key: "close",
        value: function() {
        ...
        value: function() {
          if (this.area.topl) {
            var A = this.canvas.clientWidth / this.canvas.getAttribute("width");
            this.setLeft(this.area.topl[0] * A), this.setTop(this.area.topl[1] * A), this.setRight(this.area.el.clientWidth - (this.area.bottoml[0] - this.area.topl[0]) * A), this.setBottom(this.area.el.clientHeight - (this.area.bottoml[1] - this.area.topl[1]) * A)
          }
        }
      }, {
        key: "rectLeft",
        ...
        value: function(A) {
          var e = A,
            t = this.rectLeft() + this.area.rect.clientWidth;
          return e < this.main.elLeft() ? this.main.elLeft() : (e > t && (e = t, this.area.resizingL && (this.area.resizingL = !1, this.area.resizingR = !0)), e)
        }
      }, {
        key: "fixCropperRight",
        value: function(A) {
          var e = A,
            t = this.main.elLeft() + this.area.el.clientWidth;
          return e > t ? t : (e < this.rectLeft() && (e = this.rectLeft() + this.area.rect.clientWidth, this.area.resizingR && (this.area.resizingR = !1, this.area.resizingL = !0)), e)
        }
      }, {
        key: "fixCropperTop",
        value: function(A) {
          var e = A,
            t = this.rectTop() + this.area.rect.clientHeight;
          return e < this.main.elTop() ? this.main.elTop() : (e > t && (e = t, this.area.resizingT && (this.area.resizingT = !1, this.area.resizingB = !0)), e)
        }
      }, {
        key: "fixCropperBottom",
        value: function(A) {
          var e = A,
            t = this.main.elTop() + this.area.el.clientHeight;
          return e > t ? t : (e < this.rectTop() && (e = this.rectTop() + this.area.rect.clientHeight, this.area.resizingB && (this.area.resizingB = !1, this.area.resizingT = !0)), e)
        }
      }], [{
        key: "code",
        value: function() {
    ...
    s = function() {
      function A(e) {
        ...
        r(this, A), this.main = e, this.wrapper = e.wrapper.querySelector(".ptro-settings-widget-wrapper"), this.inputPixelSize = e.wrapper.querySelector(".ptro-settings-widget-wrapper .ptro-pixel-size-input"), this.applyButton = e.wrapper.querySelector(".ptro-settings-widget-wrapper button.ptro-apply"), this.closeButton = e.wrapper.querySelector(".ptro-settings-widget-wrapper button.ptro-close"), this.clearButton = e.wrapper.querySelector(".ptro-settings-widget-wrapper button.ptro-clear"), this.bgSelBtn = e.wrapper.querySelector(".ptro-settings-widget-wrapper .ptro-color-btn"), this.errorHolder = e.wrapper.querySelector(".ptro-settings-widget-wrapper .ptro-error"), this.clearButton.onclick = function() {
          t.main.currentBackground = t.main.colorWidgetState.bg.alphaColor, t.main.currentBackgroundAlpha = t.main.colorWidgetState.bg.alpha, t.main.clearBackground(), t.startClose()
        }, this.bgSelBtn.onclick = function() {
          t.main.colorPicker.open(t.main.colorWidgetState.bg)
        }, this.closeButton.onclick = function() {
          t.startClose()
        }, this.applyButton.onclick = function() {
          var A = (0, o.trim)(t.inputPixelSize.value),
            e = void 0;
          if ("%" === A.slice(-1)) {
            var r = (0, o.trim)(A.slice(0, -1));
            e = /^\d+$/.test(r) && 0 !== parseInt(r, 10), e && (A = r + "%")
          } else e = /^\d+$/.test(A) && 0 !== parseInt(A, 10);
          e ? (t.main.select.pixelizePixelSize = A, (0, a.setParam)("pixelizePixelSize", A), t.startClose(), t.errorHolder.setAttribute("hidden", "")) : (t.errorHolder.innerText = (0, n.tr)("wrongPixelSizeValue"), t.errorHolder.removeAttribute("hidden"))
        }
      }
      return i(A, [{
        key: "handleKeyDown",
        ...
        key: "open",
        value: function() {
          this.wrapper.removeAttribute("hidden"), this.opened = !0, this.inputPixelSize.value = this.main.select.pixelizePixelSize, this.bgSelBtn.style["background-color"] = this.main.colorWidgetState.bg.alphaColor
        }
      }, {
        key: "close",
        value: function() {
  ...
  var i = function() {
    ...
    l = function() {
      ...
      return i(A, [{
        ...
        key: "setFont",
        value: function(A) {
          this.font = A, this.input.style["font-family"] = A, this.active && this.input.focus(), this.active && this.reLimit()
        }
      }, {
        key: "setFontStyle",
        value: function(A) {
          this.fontStyle = A, (0, a.checkIn)("bold", this.fontStyle) ? this.input.style["font-weight"] = "bold" : this.input.style["font-weight"] = "normal", (0, a.checkIn)("italic", this.fontStyle) ? this.input.style["font-style"] = "italic" : this.input.style["font-style"] = "normal", this.active && this.input.focus(), this.active && this.reLimit()
        }
      }, {
        key: "setFontSize",
        value: function(A) {
          this.fontSize = A, this.input.style["font-size"] = A + "px", this.active && this.reLimit()
        }
      }, {
        key: "setFontStrokeSize",
        value: function(A) {
          this.fontStrokeSize = A, this.input.style["-webkit-text-stroke"] = this.fontStrokeSize + "px " + this.strokeColor, this.active && this.input.focus(), this.active && this.reLimit()
        }
      }, {
        key: "setFontColor",
        value: function(A) {
          this.color = A, this.input.style.color = A
        }
      }, {
        key: "setStrokeColor",
        value: function(A) {
          this.strokeColor = A, this.input.style["-webkit-text-stroke"] = this.fontStrokeSize + "px " + this.strokeColor
        }
      }, {
        key: "inputLeft",
        value: function() {
        ...
        value: function(A) {
          var e = this;
          if ("ptro-crp-el" === A.target.classList[0]) {
            this.active || (this.input.innerHTML = "<br>", this.pendingClear = !0), this.active = !0, this.crd = [A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft, A.clientY - this.main.elTop() + this.main.scroller.scrollTop];
            var t = this.main.getScale();
            this.scaledCord = [this.crd[0] * t, this.crd[1] * t], this.inputWrapper.style.left = this.crd[0] + "px", this.inputWrapper.style.top = this.crd[1] + "px", this.inputWrapper.style.display = "inline", this.input.focus(), this.reLimit(), this.input.onkeydown = function(A) {
              A.ctrlKey && A.keyCode === a.KEYS.enter && (e.apply(), A.preventDefault()), A.keyCode === a.KEYS.esc && (e.close(), e.main.closeActiveTool(), A.preventDefault()), e.reLimit(), e.pendingClear && (e.input.innerText = e.input.innerText.slice(1), e.pendingClear = !1)
            }, this.main.isMobile || A.preventDefault()
          }
        }
      }, {
        key: "apply",
        value: function() {
          ...
          this.input.style.border = "none", (0, o.default)(this.input, {
            backgroundColor: null,
            logging: !1,
            scale: 1 / this.main.zoomFactor
          }).then(function(t) {
            A.ctx.drawImage(t, A.scaledCord[0], A.scaledCord[1]), A.input.style.border = e, A.close(), A.main.worklog.captureState(), A.main.closeActiveTool()
          })
        }
      }, {
        key: "close",
        ...
        key: "getFonts",
        value: function() {
          var A = ["Arial, Helvetica, sans-serif", '"Arial Black", Gadget, sans-serif', '"Comic Sans MS", cursive, sans-serif', "Impact, Charcoal, sans-serif", '"Lucida Sans Unicode", "Lucida Grande", sans-serif', "Tahoma, Geneva, sans-serif", '"Trebuchet MS", Helvetica, sans-serif', "Verdana, Geneva, sans-serif", '"Courier New", Courier, monospace', '"Lucida Console", Monaco, monospace'],
            e = [];
          return A.forEach(function(A) {
            e.push({
              value: A,
              name: A.split(",")[0].replace(/"/g, ""),
              extraStyle: "font-family:" + A,
              title: A.split(",")[0].replace(/"/g, "")
            })
          }), e
        }
      }, {
        ...
        key: "code",
        value: function() {
          return '<span class="ptro-text-tool-input-wrapper"><div contenteditable="true" class="ptro-text-tool-input"></div><span class="ptro-text-tool-buttons"><button type="button" class="ptro-text-tool-apply ptro-icon-btn ptro-color-control" title="' + (0, s.tr)("apply") + '" \n                   style="margin: 2px"><i class="ptro-icon ptro-icon-apply"></i></button><button type="button" class="ptro-text-tool-cancel ptro-icon-btn ptro-color-control" title="' + (0, s.tr)("cancel") + '"\n                   style="margin: 2px"><i class="ptro-icon ptro-icon-close"></i></button></span></span>'
        }
      }]), A
    }();
  e.default = l
  ...
  var i = function() {
    ...
    n = function() {
      function A(e, t) {
        r(this, A), this.main = e, this.current = null, this.changedHandler = t, this.empty = !0, this.clean = !0, this.ctx = e.ctx
      }
      return i(A, [{
        ...
        value: function(A) {
          ...
          if (void 0 !== A.limit) {
            ...
            var i = e,
              n = void 0;
            for (n = 0; n < r; n += 1) i.prevCount = r - n, n < r - 1 && i.prev && (i = i.prev);
            i.prev = null
          }
        ...
        value: function(A) {
          ...
          null === this.current ? (e.prev = null, e.prevCount = 0, this.first = e, this.clearedCount = 0) : (e.prev = this.current, e.prevCount = this.current.prevCount + 1, this.current.next = e), e.next = null, this.current = e, this.changed(A)
        }
      }, {
        key: "reCaptureState",
        value: function() {
        ...
        key: "applyState",
        value: function(A) {
          this.main.resize(A.sizew, A.sizeh), this.main.ctx.putImageData(A.data, 0, 0), this.main.adjustSizeFull(), this.main.select.hide()
        }
      }, {
        key: "undoState",
        value: function() {
          null !== this.current.prev && (this.current = this.current.prev, this.applyState(this.current), this.changed(!1))
        }
      }, {
        key: "redoState",
        value: function() {
          null !== this.current.next && (this.current = this.current.next, this.applyState(this.current), this.changed(!1))
        }
      }]), A
    }();
  e.default = n
      ...
      return i(A, [{
        ...
        value: function(A) {
          if (this.main.colorPicker.choosing && !A.altKey) {
            ...
            var e = this.main.getScale(),
              t = [A.clientX - this.main.elLeft() + this.main.scroller.scrollLeft, A.clientY - this.main.elTop() + this.main.scroller.scrollTop],
              r = t[0] * e;
            r = r < 1 ? 1 : r, r = r > this.main.size.w - 1 ? this.main.size.w - 1 : r;
            var i = t[1] * e;
            i = i < 1 ? 1 : i, i = i > this.main.size.h - 1 ? this.main.size.h - 1 : i;
            for (var n = this.captW, o = this.periodW, a = 0; a < n; a += 1)
              for (var s = 0; s < n; s += 1)
                for (var l = this.ctx.getImageData(r + a - this.middle, i + s - this.middle, 1, 1), c = 0; c < o; c += 1)
                  for (var u = 0; u < o; u += 1) c === o - 1 || u === o - 1 ? a === this.middle && s === this.middle || a === this.middle && s === this.middle - 1 && u === o - 1 || a === this.middle - 1 && s === this.middle && c === o - 1 ? this.zomerCtx.putImageData(this.gridColorRed, a * o + c, s * o + u) : this.zomerCtx.putImageData(this.gridColor, a * o + c, s * o + u) : this.zomerCtx.putImageData(l, a * o + c, s * o + u);
            this.zomer.style.left = A.clientX - this.wrapper.documentOffsetLeft - this.halfFullW + "px", this.zomer.style.top = A.clientY - this.wrapper.documentOffsetTop - this.halfFullW + "px"
    ...
    var o = /iPhone/i,
      ...
      U = function(A) {
        var e = A || navigator.userAgent,
          t = e.split("[FBAN");
        if (void 0 !== t[1] && (e = t[0]), t = e.split("Twitter"), void 0 !== t[1] && (e = t[0]), this.apple = {
            phone: M(o, e),
            ipod: M(a, e),
            tablet: !M(o, e) && M(s, e),
            device: M(o, e) || M(a, e) || M(s, e)
          }, this.amazon = {
            phone: M(u, e),
            tablet: !M(u, e) && M(B, e),
            device: M(u, e) || M(B, e)
            ...
            phone: M(u, e) || M(l, e),
            tablet: !M(u, e) && !M(l, e) && (M(B, e) || M(c, e)),
            ...
            firefox: M(C, e),
            chrome: M(p, e),
            device: M(d, e) || M(w, e) || M(Q, e) || M(C, e) || M(p, e)
          }, this.seven_inch = M(f, e), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch, this.phone = this.apple.phone || this.android.phone || this.windows.phone, this.tablet = this.apple.tablet || this.android.tablet || this.windows.tablet, "undefined" == typeof window) return this
      },
      N = function() {
        var A = new U;
        return A.Class = U, A
      };
    void 0 !== A && A.exports && "undefined" == typeof window ? A.exports = U : void 0 !== A && A.exports && "undefined" != typeof window ? A.exports = N() : (i = [], r = t.isMobile = N(), void 0 !== (n = "function" == typeof r ? r.apply(e, i) : r) && (A.exports = n))
  }(void 0)
}, function(A, e, t) {
  var r = t(81);
  "string" == typeof r && (r = [
  ...
  var n = function() {
    ...
    g = e.BREAK_NOT_ALLOWED = "×",
    h = e.BREAK_ALLOWED = "÷",
    d = e.UnicodeTrie = (0, a.createTrieFromBase64)(l.default),
    w = [30, 36],
    Q = [1, 2, 3, 5],
    p = [10, 8],
    C = [27, 26],
    ...
    M = [38, 39, 40, 34, 35],
    U = [15, 13],
    N = e.codePointsToCharacterClasses = function(A) {
      ...
      return A.forEach(function(A, n) {
        var o = d.get(A);
        if (o > u ? (i.push(!0), o -= u) : i.push(!1), -1 !== ["normal", "auto", "loose"].indexOf(e) && -1 !== [8208, 8211, 12316, 12448].indexOf(A)) return r.push(n), t.push(16);
        if (4 === o || 11 === o) {
          if (0 === n) return r.push(n), t.push(30);
          var a = t[n - 1];
          return -1 === f.indexOf(a) ? (r.push(r[n - 1]), t.push(a)) : (r.push(n), t.push(30))
        }
        return r.push(n), 31 === o ? t.push("strict" === e ? 21 : 37) : 42 === o ? t.push(30) : 29 === o ? t.push(30) : 43 === o ? A >= 131072 && A <= 196605 || A >= 196608 && A <= 262141 ? t.push(37) : t.push(30) : void t.push(o)
      }), [r, t, i]
    },
    I = function(A, e, t, r) {
      var i = r[t];
    ...
    E = function(A, e, t, r, i) {
      if (0 === t[r]) return g;
      var n = r - 1;
      if (Array.isArray(i) && !0 === i[n]) return g;
      var o = n - 1,
        a = n + 1,
        s = e[n],
        l = o >= 0 ? e[o] : 0,
        c = e[a];
      if (2 === s && 3 === c) return g;
      if (-1 !== Q.indexOf(s)) return B;
      if (-1 !== Q.indexOf(c)) return g;
      if (-1 !== p.indexOf(c)) return g;
      if (8 === T(n, e)) return h;
      if (11 === d.get(A[n]) && (37 === c || 32 === c || 33 === c)) return g;
      if (7 === s || 7 === c) return g;
      if (9 === s) return g;
      if (-1 === [10, 13, 15].indexOf(s) && 9 === c) return g;
      if (-1 !== [17, 18, 19, 24, 28].indexOf(c)) return g;
      if (22 === T(n, e)) return g;
      if (I(23, 22, n, e)) return g;
      if (I([17, 18], 21, n, e)) return g;
      if (I(12, 12, n, e)) return g;
      if (10 === s) return h;
      if (23 === s || 23 === c) return g;
      if (16 === c || 16 === s) return h;
      if (-1 !== [13, 15, 21].indexOf(c) || 14 === s) return g;
      if (36 === l && -1 !== U.indexOf(s)) return g;
      if (28 === s && 36 === c) return g;
      if (20 === c && -1 !== w.concat(20, 19, 25, 37, 32, 33).indexOf(s)) return g;
      if (-1 !== w.indexOf(c) && 25 === s || -1 !== w.indexOf(s) && 25 === c) return g;
      if (27 === s && -1 !== [37, 32, 33].indexOf(c) || -1 !== [37, 32, 33].indexOf(s) && 26 === c) return g;
      if (-1 !== w.indexOf(s) && -1 !== C.indexOf(c) || -1 !== C.indexOf(s) && -1 !== w.indexOf(c)) return g;
      if (-1 !== [27, 26].indexOf(s) && (25 === c || -1 !== [22, 15].indexOf(c) && 25 === e[a + 1]) || -1 !== [22, 15].indexOf(s) && 25 === c || 25 === s && -1 !== [25, 28, 24].indexOf(c)) return g;
      ...
      if (-1 !== [27, 26].indexOf(c))
        for (var N = -1 !== [17, 18].indexOf(s) ? o : n; N >= 0;) {
          var E = e[N];
          if (25 === E) return g;
          if (-1 === [28, 24].indexOf(E)) break;
          N--
        }
      if (38 === s && -1 !== [38, 39, 34, 35].indexOf(c) || -1 !== [39, 34].indexOf(s) && -1 !== [39, 40].indexOf(c) || -1 !== [40, 35].indexOf(s) && 40 === c) return g;
      if (-1 !== M.indexOf(s) && -1 !== [20, 26].indexOf(c) || -1 !== M.indexOf(c) && 27 === s) return g;
      if (-1 !== w.indexOf(s) && -1 !== w.indexOf(c)) return g;
      if (24 === s && -1 !== w.indexOf(c)) return g;
      if (-1 !== w.concat(25).indexOf(s) && 22 === c || -1 !== w.concat(25).indexOf(c) && 18 === s) return g;
      if (41 === s && 41 === c) {
        for (var D = t[n], F = 1; D > 0 && (D--, 41 === e[D]);) F++;
        if (F % 2 != 0) return g
      }
      return 32 === s && 33 === c ? g : h
    },
    D = (e.lineBreakAtIndex = function(A, e) {
      if (0 === e) return g;
      if (e >= A.length) return B;
      var t = N(A),
        r = o(t, 2),
        i = r[0],
        n = r[1];
      ...
      })), [i, n, "keep-all" === e.wordBreak ? a.map(function(e, t) {
        return e && A[t] >= 19968 && A[t] <= 40959
      }) : null]
    }),
    F = (e.inlineBreakOpportunities = function(A, e) {
      ...
      return t.forEach(function(A, e) {
        r += (0, c.fromCodePoint)(A) + (e >= t.length - 1 ? B : E(t, s, a, e + 1, l))
      }), r
    }, function() {
      function A(e, t, r, n) {
        i(this, A), this._codePoints = e, this.required = t === B, this.start = r, this.end = n
      }
      return n(A, [{
        key: "slice",
        value: function() {
          return c.fromCodePoint.apply(void 0, r(this._codePoints.slice(this.start, this.end)))
        }
      }]), A
    }());
  e.LineBreaker = function(A, e) {
    ...
    return {
      next: function() {
        ...
        for (var A = g; B < l && (A = E(t, a, n, ++B, s)) === g;);
        if (A !== g || B === l) {
          var e = new F(t, A, u, B);
          return u = B, {
            value: e,
  ...
  var i = function() {
    ...
    l = e.UTRIE2_SHIFT_1_2 = a - o,
    c = e.UTRIE2_LSCP_INDEX_2_OFFSET = 65536 >> o,
    u = e.UTRIE2_DATA_BLOCK_LENGTH = 1 << o,
    B = e.UTRIE2_DATA_MASK = u - 1,
    g = e.UTRIE2_LSCP_INDEX_2_LENGTH = 1024 >> o,
    h = e.UTRIE2_INDEX_2_BMP_LENGTH = c + g,
    d = e.UTRIE2_UTF8_2B_INDEX_2_OFFSET = h,
    w = e.UTRIE2_UTF8_2B_INDEX_2_LENGTH = 32,
    Q = e.UTRIE2_INDEX_1_OFFSET = d + w,
    p = e.UTRIE2_OMITTED_BMP_INDEX_1_LENGTH = 65536 >> a,
    C = e.UTRIE2_INDEX_2_BLOCK_LENGTH = 1 << l,
    ...
    M = (e.createTrieFromBase64 = function(A) {
      ...
      return new M(t[0], t[1], t[2], t[3], i, o)
    }, e.Trie = function() {
      function A(e, t, i, n, o, a) {
        r(this, A), this.initialValue = e, this.errorValue = t, this.highStart = i, this.highValueIndex = n, this.index = o, this.data = a
      }
      return i(A, [{
        key: "get",
        value: function(A) {
          var e = void 0;
          if (A >= 0) {
            if (A < 55296 || A > 56319 && A <= 65535) return e = this.index[A >> o], e = (e << s) + (A & B), this.data[e];
            if (A <= 65535) return e = this.index[c + (A - 55296 >> o)], e = (e << s) + (A & B), this.data[e];
            if (A < this.highStart) return e = Q - p + (A >> a), e = this.index[e], e += A >> o & f, e = this.index[e], e = (e << s) + (A & B), this.data[e];
  ...
  var c = t(41),
    ...
    v = function() {
      function A(e) {
        var t = this;
        i(this, A), (0, h.addDocumentObjectHelpers)(), this.params = (0, C.setDefaults)(e), this.controlBuilder = new H.default(this), this.colorWidgetState = {
          line: {
            target: "line",
        ...
        }, this.currentBackground = this.colorWidgetState.bg.alphaColor, this.currentBackgroundAlpha = this.colorWidgetState.bg.alpha, this.tools = [{
          name: "select",
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.select.activate(), t.select.draw()
          },
          close: function() {
            t.select.close(), t.toolContainer.style.cursor = "auto"
          },
          ...
          name: "crop",
          activate: function() {
            t.select.doCrop(), t.closeActiveTool()
          }
        }, {
          name: "pixelize",
          activate: function() {
            t.select.doPixelize(), t.closeActiveTool()
          }
        }, {
          name: "line",
          controls: [{
            ...
            action: function() {
              t.colorPicker.open(t.colorWidgetState.line)
            }
          }, this.controlBuilder.buildLineWidthControl(1)],
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.primitiveTool.activate("line")
          },
          eventListner: function() {
            return t.primitiveTool
          }
        }, {
          name: "rect",
          controls: [{
            ...
            target: "fill",
            action: function() {
              t.colorPicker.open(t.colorWidgetState.fill)
            }
          }, this.controlBuilder.buildLineWidthControl(2)],
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.primitiveTool.activate("rect")
          },
          eventListner: function() {
            return t.primitiveTool
          }
          ...
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.primitiveTool.activate("ellipse")
          },
          eventListner: function() {
            return t.primitiveTool
          }
          ...
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.primitiveTool.activate("brush")
          },
          eventListner: function() {
            return t.primitiveTool
          }
          ...
          activate: function() {
            t.toolContainer.style.cursor = "crosshair", t.primitiveTool.activate("eraser")
          },
          eventListner: function() {
            return t.primitiveTool
          }
          ...
          controls: [{
            ...
            target: "line",
            action: function() {
              t.colorPicker.open(t.colorWidgetState.line, function(A) {
                t.textTool.setFontColor(A.alphaColor)
              })
            }
            ...
            target: "fontName",
            action: function() {
              var A = document.getElementById(t.activeTool.controls[2].id),
                e = A.value;
              t.textTool.setFont(e)
            },
            getValue: function() {
              return t.textTool.getFont()
            },
            getAvailableValues: function() {
            ...
            target: "fontStyle",
            action: function() {
              var A = document.getElementById(t.activeTool.controls[3].id),
                e = A.value;
              t.textTool.setFontStyle(e)
            },
            getValue: function() {
              return t.textTool.getFontStyle()
            },
            getAvailableValues: function() {
          ...
          activate: function() {
            t.textTool.setFontColor(t.colorWidgetState.line.alphaColor), t.toolContainer.style.cursor = "crosshair"
          },
          close: function() {
            t.textTool.close()
          },
          ...
          activate: function() {
            var A = t.size.w,
              e = t.size.h,
              r = t.ctx.getImageData(0, 0, t.size.w, t.size.h),
              i = t.doc.createElement("canvas");
            i.width = A, i.height = e, i.getContext("2d").putImageData(r, 0, 0), t.resize(e, A), t.ctx.save(), t.ctx.translate(e / 2, A / 2), t.ctx.rotate(90 * Math.PI / 180), t.ctx.drawImage(i, -A / 2, -e / 2), t.adjustSizeFull(), t.ctx.restore(), t.worklog.captureState(), t.closeActiveTool()
          }
        }, {
          name: "resize",
          activate: function() {
          ...
          name: "undo",
          activate: function() {
            t.worklog.undoState(), t.closeActiveTool()
          },
          eventListner: function() {
            return t.resizer
          }
          ...
          activate: function() {
            t.closeActiveTool();
            var A = document.getElementById("ptro-file-input");
            A.click(), A.onchange = function(e) {
              var r = e.target.files || e.dataTransfer.files;
              r.length && (t.openFile(r[0]), A.value = "")
            }
          }
        }, {
          name: "close",
          right: !0,
          activate: function() {
            t.closeActiveTool(), t.close(), t.hide()
          }
        }], this.isMobile = a.default.any, this.toolByName = {}, this.tools.forEach(function(A) {
          t.toolByName[A.name] = A
        }), this.activeTool = void 0, this.zoom = !1, this.ratioRelation = void 0, this.id = this.params.id, this.saving = !1, void 0 === this.id ? (this.id = (0, h.genId)(), this.holderId = (0, h.genId)(), this.holderEl = document.createElement("div"), this.holderEl.id = this.holderId, this.holderEl.className = "ptro-holder-wrapper", document.getElementById("js-paint-section").appendChild(this.holderEl), this.holderEl.innerHTML = "<div id='" + this.id + '\' class="ptro-holder"></div>', this.baseEl = document.getElementById(this.id)) : (this.baseEl = document.getElementById(this.id), this.holderEl = null);
        var r = "",
          n = "";
        this.tools.filter(function(A) {
          return -1 === t.params.hiddenTools.indexOf(A.name)
        }).forEach(function(A) {
          var e = (0, h.genId)();
          A.buttonId = e;
          var t = '<button type="button" class="ptro-icon-btn ptro-color-control" title="' + (0, f.tr)("tools." + A.name) + '" id="' + e + '" ><i class="ptro-icon ptro-icon-' + A.name + '"></i></button>';
          A.right ? n += t : r += t
        }), this.inserter = new F.default;
        var o = '<div class="ptro-crp-el">' + u.default.code() + I.default.code() + "</div>";
        ...
        s.type = "text/css", s.innerHTML = this.params.styles, this.baseEl.appendChild(s), this.saveBtn = this.doc.getElementById(this.toolByName.save.buttonId), this.saveBtn && this.saveBtn.setAttribute("disabled", "true"), this.body = this.doc.body, this.info = this.doc.querySelector("#" + this.id + "-bar .ptro-info"), this.canvas = this.doc.querySelector("#" + this.id + "-canvas"), this.ctx = this.canvas.getContext("2d"), this.toolControls = this.doc.querySelector("#" + this.id + "-bar .tool-controls"), this.toolContainer = this.doc.querySelector("#" + this.id + "-wrapper .ptro-crp-el"), this.substrate = this.doc.querySelector("#" + this.id + "-wrapper .ptro-substrate"), this.zoomHelper = new U.default(this), this.select = new u.default(this, function(A) {
          [t.toolByName.crop, t.toolByName.pixelize].forEach(function(e) {
            t.setToolEnabled(e, A)
          })
        }), this.resizer = new E.default(this), this.settings = new m.default(this), this.primitiveTool = new w.default(this), this.primitiveTool.setLineWidth(this.params.defaultLineWidth), this.primitiveTool.setEraserWidth(this.params.defaultEraserWidth), this.primitiveTool.setPixelSize(this.params.defaultPixelSize), this.worklog = new g.default(this, function(A) {
          t.saveBtn && !A.initial && t.saveBtn.removeAttribute("disabled"), t.setToolEnabled(t.toolByName.undo, !A.first), t.params.changeHandler && t.params.changeHandler.call(t, {
            image: t.imageSaver,
            operationsDone: t.worklog.current.prevCount,
            realesedMemoryOperations: t.worklog.clearedCount
          })
        }), this.inserter.init(this), this.textTool = new I.default(this), this.colorPicker = new p.default(this, function(A) {
          t.colorWidgetState[A.target] = A, t.doc.querySelector("#" + t.id + " .ptro-color-btn[data-id='" + A.target + "']").style["background-color"] = A.alphaColor, "line" === A.target ? ((0, C.setParam)("activeColor", A.palleteColor), (0, C.setParam)("activeColorAlpha", A.alpha)) : "fill" === A.target ? ((0, C.setParam)("activeFillColor", A.palleteColor), (0, C.setParam)("activeFillColorAlpha", A.alpha)) : "bg" === A.target ? ((0, C.setParam)("backgroundFillColor", A.palleteColor), (0, C.setParam)("backgroundFillColorAlpha", A.alpha)) : "stroke" === A.target && ((0, C.setParam)("textStrokeColor", A.palleteColor), (0, C.setParam)("textStrokeColorAlpha", A.alpha))
        }), this.defaultTool = this.toolByName[this.params.defaultTool] || this.toolByName.select, this.tools.filter(function(A) {
          return -1 === t.params.hiddenTools.indexOf(A.name)
        }).forEach(function(A) {
          t.getBtnEl(A).onclick = function() {
            if (A !== t.defaultTool || t.activeTool !== A) {
              var e = t.activeTool;
              t.closeActiveTool(!0), e !== A ? t.setActiveTool(A) : t.setActiveTool(t.defaultTool)
            }
          }, t.getBtnEl(A).ontouch = t.getBtnEl(A).onclick
        }), this.setActiveTool(this.defaultTool), this.imageSaver = {
          asDataURL: function(A, e) {
            var r = A;
            return void 0 === r && (r = "image/png"), t.getAsUri(r, e)
          },
          asBlob: function(A, e) {
            var r = A;
            void 0 === r && (r = "image/png");
            for (var i = t.getAsUri(r, e), n = atob(i.split(",")[1]), o = new ArrayBuffer(n.length), a = new Uint8Array(o), s = 0; s < n.length; s += 1) a[s] = n.charCodeAt(s);
            return new Blob([o], {
              type: r
            })
          },
          suggestedFileName: function(A) {
            var e = A;
            return void 0 === e && (e = "png"), (t.loadedName || "image-" + (0, h.genId)()) + "." + e
          }
      ...
      return n(A, [{
        key: "setToolEnabled",
        value: function(A, e) {
          var t = this.doc.getElementById(A.buttonId);
          t && (e ? t.removeAttribute("disabled") : t.setAttribute("disabled", "true"))
        }
      }, {
        key: "getAsUri",
        value: function(A, e) {
          var t = e;
          return void 0 === t && (t = .92), this.canvas.toDataURL(A, t)
        }
      }, {
        key: "getBtnEl",
        value: function(A) {
          return this.doc.getElementById(A.buttonId)
        }
      }, {
        key: "save",
        value: function() {
          ...
          var e = this.doc.getElementById(this.toolByName.save.buttonId),
            t = this.doc.querySelector("#" + this.toolByName.save.buttonId + " > i");
          return e && e.setAttribute("disabled", "true"), t && (t.className = "ptro-icon ptro-icon-loading ptro-spinning"), void 0 !== this.params.saveHandler ? this.params.saveHandler(this.imageSaver, function(e) {
            !0 === e && A.hide(), t && (t.className = "ptro-icon ptro-icon-save"), A.saving = !1
          }) : ((0, C.logError)("No saveHandler defined, please check documentation"), t && (t.className = "ptro-icon ptro-icon-save"), this.saving = !1), this
        }
      }, {
        key: "close",
        value: function() {
          void 0 !== this.params.closeHandler && this.params.closeHandler()
        }
      }, {
        key: "closeActiveTool",
        value: function(A) {
          ...
          }!0 !== A && this.setActiveTool(this.defaultTool)
        }
      }, {
        key: "handleToolEvent",
        value: function(A, e) {
          if (this.activeTool && this.activeTool.eventListner) {
            var t = this.activeTool.eventListner();
            t[A] && t[A](e)
          }
        }
      }, {
        ...
        value: function() {
          ...
          this.documentHandlers = {
            mousedown: function(e) {
              A.shown && (!A.worklog.empty || -1 === e.target.className.indexOf("ptro-crp-el") && -1 === e.target.className.indexOf("ptro-icon") && -1 === e.target.className.indexOf("ptro-named-btn") || A.clearBackground(), !0 !== A.colorPicker.handleMouseDown(e) && A.handleToolEvent("handleMouseDown", e))
            },
            touchstart: function(e) {
              if (1 === e.touches.length) e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY, A.documentHandlers.mousedown(e);
            ...
            touchend: function(e) {
              e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY, A.documentHandlers.mouseup(e)
            },
            touchmove: function(e) {
              if (1 === e.touches.length) e.clientX = e.changedTouches[0].clientX, e.clientY = e.changedTouches[0].clientY, A.documentHandlers.mousemove(e);
              else if (2 === e.touches.length) {
                var t = (0, h.distance)({
                  x: e.changedTouches[0].clientX,
                  y: e.changedTouches[0].clientY
                ...
                t > A.lastFingerDist ? (e.wheelDelta = 1, e.ctrlKey = !0, A.documentHandlers.mousewheel(e)) : t > A.lastFingerDist && (e.wheelDelta = -1, e.ctrlKey = !0, A.documentHandlers.mousewheel(e)), A.lastFingerDist = t, e.stopPropagation(), e.preventDefault()
              }
            },
            mousemove: function(e) {
              if (A.shown) {
                A.handleToolEvent("handleMouseMove", e), A.colorPicker.handleMouseMove(e), A.zoomHelper.handleMouseMove(e), A.curCord = [e.clientX - A.elLeft() + A.scroller.scrollLeft, e.clientY - A.elTop() + A.scroller.scrollTop];
                var t = A.getScale();
                A.curCord = [A.curCord[0] * t, A.curCord[1] * t], "input" !== e.target.tagName.toLowerCase() && "button" !== e.target.tagName.toLowerCase() && "i" !== e.target.tagName.toLowerCase() && "select" !== e.target.tagName.toLowerCase() && e.preventDefault()
              }
            },
            mouseup: function(e) {
              A.shown && (A.handleToolEvent("handleMouseUp", e), A.colorPicker.handleMouseUp(e))
            },
            mousewheel: function(e) {
              if (A.shown && e.ctrlKey) {
                var t = 1;
                A.size.w > A.wrapper.documentClientWidth && (t = Math.min(t, A.wrapper.documentClientWidth / A.size.w)), A.size.h > A.wrapper.documentClientHeight && (t = Math.min(t, A.wrapper.documentClientHeight / A.size.h)), !A.zoom && A.zoomFactor > t && (A.zoomFactor = t), A.zoomFactor += .2 * Math.sign(e.wheelDelta), A.zoomFactor < t ? (A.zoom = !1, A.zoomFactor = t) : A.zoom = !0, A.adjustSizeFull(), A.select.adjustPosition(), A.zoom && (A.scroller.scrollLeft = A.curCord[0] / A.getScale() - (e.clientX - A.wrapper.documentOffsetLeft), A.scroller.scrollTop = A.curCord[1] / A.getScale() - (e.clientY - A.wrapper.documentOffsetTop)), e.preventDefault()
              }
            },
            keydown: function(e) {
              if (A.shown) {
                A.colorPicker.handleKeyDown(e);
                var t = window.event ? event : e;
                A.handleToolEvent("handleKeyDown", t), t.keyCode === h.KEYS.y && t.ctrlKey || t.keyCode === h.KEYS.z && t.ctrlKey && t.shiftKey ? (A.worklog.redoState(), e.preventDefault()) : t.keyCode === h.KEYS.z && t.ctrlKey && (A.worklog.undoState(), e.preventDefault()), A.saveBtn && t.keyCode === h.KEYS.s && t.ctrlKey && (A.save(), t.preventDefault())
              }
            },
            paste: function(e) {
              if (A.shown) {
                ...
                Object.keys(t).forEach(function(r) {
                  var i = t[r];
                  if ("file" === i.kind && "image" === i.type.split("/")[0]) A.openFile(i.getAsFile());
                  else if ("string" === i.kind) {
                    var n = "";
                    window.clipboardData && window.clipboardData.getData ? n = window.clipboardData.getData("Text") : e.clipboardData && e.clipboardData.getData && (n = e.clipboardData.getData("text/plain")), n.startsWith(A.inserter.CLIP_DATA_MARKER) && A.loadImage(localStorage.getItem(A.inserter.CLIP_DATA_MARKER))
                  }
                })
              }
            },
            dragover: function(e) {
              if (A.shown) {
                var t = e.target.classList[0];
                "ptro-crp-el" !== t && "ptro-bar" !== t || (A.bar.className = "ptro-bar ptro-color-main ptro-bar-dragover"), e.preventDefault()
              }
            },
            dragleave: function() {
              A.shown && (A.bar.className = "ptro-bar ptro-color-main")
            },
            drop: function(e) {
              if (A.shown) {
                A.bar.className = "ptro-bar ptro-color-main", e.preventDefault();
                ...
                if (t) A.openFile(t);
                  ...
                  var r = e.dataTransfer.getData("text/html"),
                    i = /src.*?=['"](.+?)['"]/,
                    n = i.exec(r);
                  A.inserter.handleOpen(n[1])
                }
              }
            }
          }, this.windowHandlers = {
            resize: function() {
              A.shown && (A.adjustSizeFull(), A.syncToolElement())
            }
        ...
        value: function() {
          ...
          this.listenersInstalled || (Object.keys(this.documentHandlers).forEach(function(e) {
            A.doc.addEventListener(e, A.documentHandlers[e])
          }), Object.keys(this.windowHandlers).forEach(function(e) {
            window.addEventListener(e, A.windowHandlers[e])
        ...
        value: function() {
          var A = this;
          this.listenersInstalled && (Object.keys(this.documentHandlers).forEach(function(e) {
            A.doc.removeEventListener(e, A.documentHandlers[e])
          }), Object.keys(this.windowHandlers).forEach(function(e) {
            window.removeEventListener(e, A.windowHandlers[e])
          }), this.listenersInstalled = !1)
        }
      }, {
        key: "elLeft",
        ...
        key: "fitImage",
        value: function(A) {
          this.resize(A.naturalWidth, A.naturalHeight), this.ctx.drawImage(A, 0, 0), this.zoomFactor = this.wrapper.documentClientHeight / this.size.h - .2, this.adjustSizeFull(), this.worklog.captureState()
        }
      }, {
        key: "loadImage",
        value: function(A) {
          this.inserter.handleOpen(A)
        }
      }, {
        key: "show",
        value: function(A) {
          return this.shown = !0, this.scrollWidth = (0, h.getScrollbarWidth)(), this.isMobile && (this.origOverflowY = this.body.style["overflow-y"], this.params.fixMobilePageReloader && (this.body.style["overflow-y"] = "hidden")), this.baseEl.removeAttribute("hidden"), this.holderEl && this.holderEl.removeAttribute("hidden"), "string" == typeof A ? (this.loadedName = (0, h.trim)((A.substring(A.lastIndexOf("/") + 1) || "").replace(/\..+$/, "")), this.loadImage(A)) : !1 !== A && this.clear(), this.attachEventHandlers(), this
        }
      }, {
        key: "hide",
        value: function() {
          return this.isMobile && (this.body.style["overflow-y"] = this.origOverflowY), this.shown = !1, this.baseEl.setAttribute("hidden", ""), this.holderEl && this.holderEl.setAttribute("hidden", ""), this.removeEventHandlers(), this
        }
      }, {
        key: "openFile",
        value: function(A) {
          if (A) {
            this.loadedName = (0, h.trim)((A.name || "").replace(/\..+$/, ""));
        ...
        key: "adjustSizeFull",
        value: function() {
          var A = this.wrapper.documentClientWidth / this.wrapper.documentClientHeight;
          if (!1 === this.zoom)
            if (this.size.w > this.wrapper.documentClientWidth || this.size.h > this.wrapper.documentClientHeight) {
              var e = A < this.size.ratio;
              this.ratioRelation = e, e ? (this.canvas.style.width = this.wrapper.clientWidth + "px", this.canvas.style.height = "auto") : (this.canvas.style.width = "auto", this.canvas.style.height = this.wrapper.clientHeight + "px"), this.scroller.style.overflow = "hidden"
            } else this.scroller.style.overflow = "hidden", this.canvas.style.width = "auto", this.canvas.style.height = "auto", this.ratioRelation = 0;
          else this.scroller.style.overflow = "scroll", this.canvas.style.width = this.size.w * this.zoomFactor + "px", this.canvas.style.height = this.size.h * this.zoomFactor + "px", this.ratioRelation = 0;
          this.syncToolElement(), this.select.draw()
        }
      }, {
        key: "resize",
        value: function(A, e) {
          this.info.innerHTML = A + " x " + e, this.size = {
            w: A,
            h: e,
            ratio: A / e
        ...
        key: "syncToolElement",
        value: function() {
          var A = Math.round(this.canvas.documentClientWidth),
            e = this.canvas.offsetLeft,
            t = Math.round(this.canvas.documentClientHeight),
            r = this.canvas.offsetTop;
          this.toolContainer.style.left = e + "px", this.toolContainer.style.width = A + "px", this.toolContainer.style.top = r + "px", this.toolContainer.style.height = t + "px", this.substrate.style.left = e + "px", this.substrate.style.width = A + "px", this.substrate.style.top = r + "px", this.substrate.style.height = t + "px"
        }
      }, {
        key: "clear",
        value: function() {
          var A = this,
            ...
            t = "fill" === this.params.defaultSize.height ? this.wrapper.clientHeight : this.params.defaultSize.height;
          if (this.resize(e, t), this.clearBackground(), this.worklog.captureState(!0), this.worklog.clean = !0, this.syncToolElement(), this.adjustSizeFull(), this.params.initText && this.worklog.empty) {
            this.ctx.lineWidth = 3, this.ctx.strokeStyle = "#fff";
            var r = document.createElement("div");
            this.scroller.appendChild(r), r.innerHTML = '<div style="position:absolute;top:50%;width:100%;transform: translateY(-50%);">' + this.params.initText + "</div>", r.style.left = "0", r.style.top = "0", r.style.right = "0", r.style.bottom = "0", r.style["text-align"] = "center", r.style.position = "absolute", r.style.color = this.params.initTextColor, r.style["font-family"] = this.params.initTextStyle.split(/ (.+)/)[1], r.style["font-size"] = this.params.initTextStyle.split(/ (.+)/)[0], (0, l.default)(r, {
              backgroundColor: null,
              logging: !1,
              scale: 1
            }).then(function(e) {
              A.scroller.removeChild(r), A.ctx.drawImage(e, 0, 0)
            })
          }
        }
      }, {
        ...
        value: function(A) {
          var e = this;
          this.activeTool = A;
          var t = this.getBtnEl(this.activeTool);
          t && (t.className += " ptro-color-active-control");
          var r = "";
          (A.controls || []).forEach(function(A) {
            if (A.id = (0, h.genId)(), A.title && (r += '<span class="ptro-tool-ctl-name" title="' + (0, f.tr)(A.titleFull) + '">' + (0, f.tr)(A.title) + "</span>"), "btn" === A.type) r += '<button type="button" ' + (A.hint ? 'title="' + (0, f.tr)(A.hint) + '"' : "") + ' class="ptro-color-control ' + (A.icon ? "ptro-icon-btn" : "ptro-named-btn") + '" id=' + A.id + ">" + (A.icon ? '<i class="ptro-icon ptro-icon-' + A.icon + '"></i>' : "") + "<p>" + (A.name || "") + "</p></button>";
            else if ("color" === A.type) r += '<button type="button" id=' + A.id + " data-id='" + A.target + "' style=\"background-color: " + e.colorWidgetState[A.target].alphaColor + '" class="color-diwget-btn ptro-color-btn ptro-bordered-btn"></button><span class="ptro-btn-color-checkers-bar"></span>';
            else if ("int" === A.type) r += "<input id=" + A.id + ' class="ptro-input" type="number" min="' + A.min + '" max="' + A.max + "\" data-id='" + A.target + "'/>";
            else if ("dropdown" === A.type) {
              var t = "";
              A.getAvailableValues().forEach(function(A) {
                t += "<option " + (A.extraStyle ? "style='" + A.extraStyle + "'" : "") + " value='" + A.value + "' " + (A.title ? "title='" + A.title + "'" : "") + ">" + A.name + "</option>"
              }), r += "<select id=" + A.id + ' class="ptro-input" data-id=\'' + A.target + "'>" + t + "</select>"
            }
          }), this.toolControls.innerHTML = r, (A.controls || []).forEach(function(A) {
            "int" === A.type ? (e.doc.getElementById(A.id).value = A.getValue(), e.doc.getElementById(A.id).oninput = A.action) : "dropdown" === A.type ? (e.doc.getElementById(A.id).onchange = A.action, e.doc.getElementById(A.id).value = A.getValue()) : e.doc.getElementById(A.id).onclick = A.action
          }), A.activate()
        }
      }]), A
    }();
  ...
  (function(A) {
    ...
    var n = function() {
      ...
      w = e.DocumentCloner = function() {
        function e(A, t, r, n, o) {
          i(this, e), this.referenceElement = A, this.scrolledElements = [], this.copyStyles = n, this.inlineImages = n, this.logger = r, this.options = t, this.renderer = o, this.resourceLoader = new c.default(t, r, window), this.pseudoContentData = {
            counters: {},
            quoteDepth: 0
        ...
        return o(e, [{
          ...
          value: function(e) {
            ...
            if (this.inlineImages && e) {
              var r = e.style;
              Promise.all((0, B.parseBackgroundImage)(r.backgroundImage).map(function(e) {
                ...
                A.length > 1 && (r.backgroundColor = ""), r.backgroundImage = A.join(",")
                ...
                if (A && e instanceof HTMLImageElement && e.parentNode) {
                  var t = e.parentNode,
                    r = (0, u.copyCSSStyles)(e.style, A.cloneNode(!1));
                  t.replaceChild(r, e)
                }
              }).catch(function(e) {
                "production" !== A.env.NODE_ENV && t.logger.log("Unable to load image", e)
          ...
          value: function(e) {
            var t = this;
            return Promise.all(Array.from(e.styleSheets).map(function(r) {
              return r.href ? fetch(r.href).then(function(A) {
                return A.text()
              }).then(function(A) {
                return p(A, r.href)
              }).catch(function(e) {
          ...
          value: function(e) {
            ...
            if (e instanceof HTMLIFrameElement) {
              var i = e.cloneNode(!1),
                n = y();
              i.setAttribute("data-html2canvas-internal-iframe-key", n);
              var o = (0, a.parseBounds)(e, 0, 0),
                s = o.width,
                l = o.height;
              return this.resourceLoader.cache[n] = O(e, this.options).then(function(A) {
                return t.renderer(A, {
                ...
                return new Promise(function(t, r) {
                  ...
                  n.onload = function() {
                    return t(A)
                  }, n.onerror = r, n.src = A.toDataURL(), i.parentNode && i.parentNode.replaceChild((0, u.copyCSSStyles)(e.ownerDocument.defaultView.getComputedStyle(e), n), i)
                })
              }), i
            }
            if (e instanceof HTMLStyleElement && e.sheet && e.sheet.cssRules) {
              var c = [].slice.call(e.sheet.cssRules, 0).reduce(function(A, e) {
                  return A + e.cssText
                }, ""),
                B = e.cloneNode(!1);
              return B.textContent = c, B
            }
          ...
          value: function(A) {
            var e = A.nodeType === Node.TEXT_NODE ? document.createTextNode(A.nodeValue) : this.createElementClone(A),
              ...
              i = A instanceof t.HTMLElement ? t.getComputedStyle(A, ":before") : null,
              n = A instanceof t.HTMLElement ? t.getComputedStyle(A, ":after") : null;
            this.referenceElement === A && e instanceof t.HTMLElement && (this.clonedReferenceElement = e), e instanceof t.HTMLBodyElement && E(e);
            for (var o = (0, d.parseCounterReset)(r, this.pseudoContentData), a = (0, d.resolvePseudoContent)(A, i, this.pseudoContentData), s = A.firstChild; s; s = s.nextSibling)(s.nodeType !== Node.ELEMENT_NODE || "SCRIPT" !== s.nodeName && !s.hasAttribute("data-html2canvas-ignore")) && (this.copyStyles && "STYLE" === s.nodeName || e.appendChild(this.cloneNode(s)));
            var l = (0, d.resolvePseudoContent)(A, n, this.pseudoContentData);
            if ((0, d.popCounters)(o, this.pseudoContentData), A instanceof t.HTMLElement && e instanceof t.HTMLElement) switch (i && this.inlineAllImages(M(A, e, i, a, U)), n && this.inlineAllImages(M(A, e, n, l, N)), !r || !this.copyStyles || A instanceof HTMLIFrameElement || (0, u.copyCSSStyles)(r, e), this.inlineAllImages(e), 0 === A.scrollTop && 0 === A.scrollLeft || this.scrolledElements.push([e, A.scrollLeft, A.scrollTop]), A.nodeName) {
              case "CANVAS":
      ...
      Q = function(A, e) {
        return (A.cssRules ? Array.from(A.cssRules) : []).filter(function(A) {
          ...
          for (var t = (0, B.parseBackgroundImage)(A.style.getPropertyValue("src")), r = [], i = 0; i < t.length; i++)
            if ("url" === t[i].method && t[i + 1] && "format" === t[i + 1].method) {
              var n = e.createElement("a");
              n.href = t[i].args[0], e.body && e.body.appendChild(n);
              var o = {
                src: n.href,
                format: t[i + 1].args[0]
              };
      ...
      p = function(A, e) {
        ...
        return i.textContent = A, t.head && t.head.appendChild(r), t.body && t.body.appendChild(i), i.sheet ? Q(i.sheet, t) : []
      },
      C = function(A, e, t) {
      ...
      M = function(A, e, t, r, i) {
        if (t && t.content && "none" !== t.content && "-moz-alt-content" !== t.content && "none" !== t.display) {
          var n = e.ownerDocument.createElement("html2canvaspseudoelement");
          if ((0, u.copyCSSStyles)(t, n), r)
            for (var o = r.length, a = 0; a < o; a++) {
              var s = r[a];
              switch (s.type) {
                case d.PSEUDO_CONTENT_ITEM_TYPE.IMAGE:
                  var l = e.ownerDocument.createElement("img");
                  l.src = (0, B.parseBackgroundImage)("url(" + s.value + ")")[0].args[0], l.style.opacity = "1", n.appendChild(l);
                  break;
                case d.PSEUDO_CONTENT_ITEM_TYPE.TEXT:
                  n.appendChild(e.ownerDocument.createTextNode(s.value))
              }
            }
          return n.className = I + " " + T, e.className += i === U ? " " + I : " " + T, i === U ? e.insertBefore(n, e.firstChild) : e.appendChild(n), n
        }
      },
      U = ":before",
      N = ":after",
      I = "___html2canvas___pseudoelement_before",
      T = "___html2canvas___pseudoelement_after",
      E = function(A) {
      ...
      O = function(A, e) {
        try {
          ...
          return e.proxy ? (0, s.Proxy)(A.src, e).then(function(A) {
            ...
            return H(A.ownerDocument, (0, a.parseBounds)(A, 0, 0)).then(function(A) {
              var t = A.contentWindow,
                r = t.document;
              r.open(), r.write(e);
              var i = v(A).then(function() {
      ...
      H = function(e, t) {
        ...
        return r.className = "html2canvas-container", r.style.visibility = "hidden", r.style.position = "fixed", r.style.left = "-10000px", r.style.top = "0px", r.style.border = "0", r.width = t.width.toString(), r.height = t.height.toString(), r.scrolling = "no", r.setAttribute("data-html2canvas-ignore", "true"), e.body ? (e.body.appendChild(r), Promise.resolve(r)) : Promise.reject("production" !== A.env.NODE_ENV ? "Body element not found in Document that is getting rendered" : "")
      },
      v = function(A) {
      ...
      b = (e.cloneWindow = function(e, t, r, i, n, o) {
        var a = new w(r, i, n, !1, o),
          s = e.defaultView.pageXOffset,
          l = e.defaultView.pageYOffset;
        return H(e, t).then(function(i) {
          var n = i.contentWindow,
            o = n.document,
            c = v(i).then(function() {
              return a.scrolledElements.forEach(F), n.scrollTo(t.left, t.top), !/(iPad|iPhone|iPod)/g.test(navigator.userAgent) || n.scrollY === t.top && n.scrollX === t.left || (o.documentElement.style.top = -t.top + "px", o.documentElement.style.left = -t.left + "px", o.documentElement.style.position = "absolute"), a.clonedReferenceElement instanceof n.HTMLElement || a.clonedReferenceElement instanceof e.defaultView.HTMLElement || a.clonedReferenceElement instanceof HTMLElement ? Promise.resolve([i, a.clonedReferenceElement, a.resourceLoader]) : Promise.reject("production" !== A.env.NODE_ENV ? "Error finding the " + r.nodeName + " in the cloned document" : "")
            });
          return o.open(), o.write(b(document.doctype) + "<html></html>"), C(r.ownerDocument, s, l), o.replaceChild(o.adoptNode(a.documentElement), o.documentElement), o.close(), c
        })
      }, function(A) {
        var e = "";
  ...
  var n = function() {
    ...
    u = r(c),
    B = t(7),
    g = /^(to )?(left|top|right|bottom)( (left|top|right|bottom))?$/i,
    h = /^([+-]?\d*\.?\d+)% ([+-]?\d*\.?\d+)%$/i,
    d = /(px)|%|( 0)$/i,
    ...
    M = e.LinearGradient = function A(e, t) {
      i(this, A), this.type = p.LINEAR_GRADIENT, this.colorStops = e, this.direction = t
    },
    U = e.RadialGradient = function A(e, t, r, n) {
      i(this, A), this.type = p.RADIAL_GRADIENT, this.colorStops = e, this.shape = t, this.center = r, this.radius = n
    },
    N = (e.parseGradient = function(A, e, t) {
      var r = e.args,
        i = e.method,
        n = e.prefix;
      return "linear-gradient" === i ? I(r, t, !!n) : "gradient" === i && "linear" === r[0] ? I(["to bottom"].concat(v(r.slice(3))), t, !!n) : "radial-gradient" === i ? T(A, "-webkit-" === n ? H(r) : r, t) : "gradient" === i && "radial" === r[0] ? T(A, v(H(r.slice(1))), t) : void 0
    }, function(A, e, t) {
      for (var r = [], i = e; i < A.length; i++) {
        var n = A[i],
          o = d.test(n),
          a = n.lastIndexOf(" "),
          s = new l.default(o ? n.substring(0, a) : n),
          c = o ? new u.default(n.substring(a + 1)) : i === e ? new u.default("0%") : i === A.length - 1 ? new u.default("100%") : null;
        r.push({
          color: s,
          stop: c
        })
      }
      for (var B = r.map(function(A) {
          var e = A.color,
            r = A.stop;
          return {
            color: e,
        ...
        }), g = B[0].stop, h = 0; h < B.length; h++)
        if (null !== g) {
          var w = B[h].stop;
          if (null === w) {
            for (var Q = h; null === B[Q].stop;) Q++;
            for (var p = Q - h + 1, C = B[Q].stop, f = (C - g) / p; h < Q; h++) g = B[h].stop = g + f
          } else g = w
        } return B
    }),
    I = function(A, e, t) {
      var r = (0, a.parseAngle)(A[0]),
        i = g.test(A[0]),
        n = i || null !== r || h.test(A[0]),
        o = n ? null !== r ? E(t ? r - .5 * Math.PI : r, e) : i ? F(A[0], e) : y(A[0], e) : E(Math.PI, e),
        s = n ? 1 : 0,
        l = Math.min((0, B.distance)(Math.abs(o.x0) + Math.abs(o.x1), Math.abs(o.y0) + Math.abs(o.y1)), 2 * e.width, 2 * e.height);
      return new M(N(A, s, l), o)
    },
    T = function(A, e, t) {
      var r = e[0].match(Q),
        i = r && ("circle" === r[1] || void 0 !== r[3] && void 0 === r[5]) ? C.CIRCLE : C.ELLIPSE,
        n = {},
        o = {};
      r && (void 0 !== r[3] && (n.x = (0, c.calculateLengthFromValueWithUnit)(A, r[3], r[4]).getAbsoluteValue(t.width)), void 0 !== r[5] && (n.y = (0, c.calculateLengthFromValueWithUnit)(A, r[5], r[6]).getAbsoluteValue(t.height)), r[7] ? o.x = f[r[7].toLowerCase()] : void 0 !== r[8] && (o.x = (0, c.calculateLengthFromValueWithUnit)(A, r[8], r[9])), r[10] ? o.y = f[r[10].toLowerCase()] : void 0 !== r[11] && (o.y = (0, c.calculateLengthFromValueWithUnit)(A, r[11], r[12])));
      var a = {
          x: void 0 === o.x ? t.width / 2 : o.x.getAbsoluteValue(t.width),
          y: void 0 === o.y ? t.height / 2 : o.y.getAbsoluteValue(t.height)
        },
        s = O(r && r[2] || "farthest-corner", i, a, n, t);
      return new U(N(e, r ? 1 : 0, Math.min(s.x, s.y)), i, a, s)
    },
    E = function(A, e) {
      var t = e.width,
        r = e.height,
    ...
    D = function(A) {
      return Math.acos(A.width / 2 / ((0, B.distance)(A.width, A.height) / 2))
    },
    F = function(A, e) {
      switch (A) {
        case "bottom":
    ...
    m = function(A, e, t, r) {
      return [{
        ...
        var n = (0, B.distance)(e - i.x, t - i.y);
        return (r ? n < A.optimumDistance : n > A.optimumDistance) ? {
          optimumCorner: i,
          optimumDistance: n
        } : A
      }, {
    ...
    O = function(A, e, t, r, i) {
      ...
      switch (A) {
        case "closest-side":
          e === C.CIRCLE ? a = s = Math.min(Math.abs(n), Math.abs(n - i.width), Math.abs(o), Math.abs(o - i.height)) : e === C.ELLIPSE && (a = Math.min(Math.abs(n), Math.abs(n - i.width)), s = Math.min(Math.abs(o), Math.abs(o - i.height)));
          break;
        case "closest-corner":
          if (e === C.CIRCLE) a = s = Math.min((0, B.distance)(n, o), (0, B.distance)(n, o - i.height), (0, B.distance)(n - i.width, o), (0, B.distance)(n - i.width, o - i.height));
          else if (e === C.ELLIPSE) {
            var l = Math.min(Math.abs(o), Math.abs(o - i.height)) / Math.min(Math.abs(n), Math.abs(n - i.width)),
              c = m(i, n, o, !0);
            a = (0, B.distance)(c.x - n, (c.y - o) / l), s = l * a
          }
          break;
        case "farthest-side":
          e === C.CIRCLE ? a = s = Math.max(Math.abs(n), Math.abs(n - i.width), Math.abs(o), Math.abs(o - i.height)) : e === C.ELLIPSE && (a = Math.max(Math.abs(n), Math.abs(n - i.width)), s = Math.max(Math.abs(o), Math.abs(o - i.height)));
          break;
        case "farthest-corner":
          if (e === C.CIRCLE) a = s = Math.max((0, B.distance)(n, o), (0, B.distance)(n, o - i.height), (0, B.distance)(n - i.width, o), (0, B.distance)(n - i.width, o - i.height));
          else if (e === C.ELLIPSE) {
            var u = Math.max(Math.abs(o), Math.abs(o - i.height)) / Math.max(Math.abs(n), Math.abs(n - i.width)),
              g = m(i, n, o, !1);
            a = (0, B.distance)(g.x - n, (g.y - o) / u), s = u * a
          }
          break;
        default:
    ...
    H = e.transformWebkitRadialGradientArgs = function(A) {
      var e = "",
        t = "",
        r = "",
        i = "",
      ...
      l && n++;
      var c = A[n].match(a);
      c && (e = c[1] || "", r = c[2] || "", "contain" === r ? r = "closest-side" : "cover" === r && (r = "farthest-corner"), n++);
      var u = A[n].match(s);
      u && n++;
      var B = A[n].match(o);
      B && n++;
      ...
      g && n++;
      var h = B || l;
      h && h[1] && (i = h[1] + (/^\d+$/.test(h[1]) ? "px" : ""), h[2] && (i += " " + h[2] + (/^\d+$/.test(h[2]) ? "px" : "")));
      var d = g || u;
      return d && (t = d[0], d[1] || (t += "px")), !i || e || t || r || (t = i, i = ""), i && (i = "at " + i), [
        [e, r, t, i].filter(function(A) {
          return !!A
        }).join(" ")
      ].concat(A.slice(n))
    },
  ...
  (function(A) {
    ...
    var i = t(62),
      ...
      u = t(18),
      B = t(13),
      g = (e.NodeParser = function(e, t, r) {
        "production" !== A.env.NODE_ENV && r.log("Starting node parsing");
        var i = 0,
          o = new a.default(e, null, t, i++),
          s = new n.default(o, null, !0);
        return h(e, o, s, t, i), "production" !== A.env.NODE_ENV && r.log("Finished parsing node tree"), s
      }, ["SCRIPT", "HEAD", "TITLE", "OBJECT", "BR", "OPTION"]),
      h = function e(t, r, i, o, s) {
        if ("production" !== A.env.NODE_ENV && s > 5e4) throw new Error("Recursion error while parsing node tree");
        for (var h, Q = t.firstChild; Q; Q = h) {
          h = Q.nextSibling;
          var p = Q.ownerDocument.defaultView;
          if (Q instanceof p.Text || Q instanceof Text || p.parent && Q instanceof p.parent.Text) Q.data.trim().length > 0 && r.childNodes.push(l.default.fromTextNode(Q, r));
          else if (Q instanceof p.HTMLElement || Q instanceof HTMLElement || p.parent && Q instanceof p.parent.HTMLElement) {
            if (-1 === g.indexOf(Q.nodeName)) {
              var C = new a.default(Q, r, o, s++);
              if (C.isVisible()) {
                "INPUT" === Q.tagName ? (0, c.inlineInputElement)(Q, C) : "TEXTAREA" === Q.tagName ? (0, c.inlineTextAreaElement)(Q, C) : "SELECT" === Q.tagName ? (0, c.inlineSelectElement)(Q, C) : C.style.listStyle && C.style.listStyle.listStyleType !== B.LIST_STYLE_TYPE.NONE && (0, u.inlineListItemElement)(Q, C, o);
                var f = "TEXTAREA" !== Q.tagName,
                  M = d(C, Q);
                if (M || w(C)) {
                  var U = M || C.isPositioned() ? i.getRealParentStackingContext() : i,
                    N = new n.default(C, U, M);
                  U.contexts.push(N), f && e(Q, C, N, o, s)
                } else i.children.push(C), f && e(Q, C, i, o, s)
              }
            }
          } else if (Q instanceof p.SVGSVGElement || Q instanceof SVGSVGElement || p.parent && Q instanceof p.parent.SVGSVGElement) {
            var I = new a.default(Q, r, o, s++),
              T = d(I, Q);
            if (T || w(I)) {
              var E = T || I.isPositioned() ? i.getRealParentStackingContext() : i,
                D = new n.default(I, E, T);
              E.contexts.push(D)
            } else i.children.push(I)
          }
        }
      },
      d = function(A, e) {
        return A.isRootElement() || A.isPositionedWithZIndex() || A.style.opacity < 1 || A.isTransformed() || Q(A, e)
      },
      w = function(A) {
  ...
  var r = function() {
    ...
    s = (e.parseCounterReset = function(A, e) {
      ...
      for (var t = [], i = A.counterReset.split(/\s*,\s*/), n = i.length, o = 0; o < n; o++) {
        var a = i[o].split(/\s+/),
          s = r(a, 2),
          l = s[0],
          c = s[1];
      ...
      if (g && "none" !== g) {
        var h = g.split(/\s+/),
          ...
          Q = d[1],
          p = t.counters[w];
        p && (p[p.length - 1] += void 0 === Q ? 1 : parseInt(Q, 10))
      }
      for (var C = 0; C < n; C++) {
        var f = i[C];
        switch (f.type) {
          case a.STRING:
            ...
            break;
          case a.ATTRIBUTE:
            A instanceof HTMLElement && f.value && (B += A.getAttribute(f.value) || "");
            break;
          case a.COUNTER:
            var M = t.counters[f.name || ""];
            M && (B += u([M[M.length - 1]], "", f.format));
            break;
          case a.COUNTERS:
            var U = t.counters[f.name || ""];
            U && (B += u(U, f.glue, f.format));
            break;
          case a.OPENQUOTE:
            B += c(e, !0, t.quoteDepth), t.quoteDepth++;
            break;
          case a.CLOSEQUOTE:
            t.quoteDepth--, B += c(e, !1, t.quoteDepth);
            break;
          case a.URL:
            B && (l.push({
              type: o.TEXT,
      ...
      if (e && e[A]) return e[A];
      for (var t = [], r = A.length, i = !1, n = !1, o = !1, s = "", c = "", u = [], B = 0; B < r; B++) {
        var g = A.charAt(B);
        switch (g) {
          case "'":
          case '"':
            n ? s += g : (i = !i, o || i || (t.push({
              type: a.STRING,
              value: s
            }), s = ""));
            break;
              ...
              switch (s && u.push(s), c) {
                ...
                case "counters":
                  if (u.length > 0) {
                    ...
                    u.length > 1 && (d.glue = u[1]), u.length > 2 && (d.format = u[2]), t.push(d)
                  }
                  break;
                case "url":
                  u.length > 0 && t.push({
    ...
    c = function(A, e, t) {
      var r = A.quotes ? A.quotes.split(/\s+/) : ["'\"'", "'\"'"],
        i = 2 * t;
      return i >= r.length && (i = r.length - 2), e || ++i, r[i].replace(/^["']|["']$/g, "")
    },
    u = function(A, e, t) {
      for (var r = A.length, o = "", a = 0; a < r; a++) a > 0 && (o += e || ""), o += (0, i.createCounterText)(A[a], (0, n.parseListStyleType)(t || "decimal"), !1);
      return o
    }
}, function(A, e, t) {
  "use strict";
  (function(A) {
    ...
    var i = function() {
      ...
      B = function() {
        function e(A, t) {
          r(this, e), this.target = A, this.options = t, A.render(t)
        }
        return n(e, [{
          key: "renderNode",
          value: function(A) {
                ...
                if (A.childNodes.length && A.childNodes.forEach(function(t) {
                  ...
                  if (t) {
                    var r = (0, o.calculateContentBox)(A.bounds, A.style.padding, A.style.border),
                      i = "number" == typeof t.width && t.width > 0 ? t.width : r.width,
                      n = "number" == typeof t.height && t.height > 0 ? t.height : r.height;
                    i > 0 && n > 0 && e.target.clip([(0, o.calculatePaddingBoxPath)(A.curvedBounds)], function() {
                      e.target.drawImage(t, new o.Bounds(0, 0, i, n), r)
                    })
                  }
                }
              },
            ...
            var e = this,
              ...
              i = function() {
                ...
                t && e.target.clip([r], function() {
                  ...
                  t.borderStyle === u.BORDER_STYLE.NONE || t.borderColor.isTransparent() || e.renderBorder(t, r, A.curvedBounds)
                })
              };
            if (t || r) {
              var n = A.parent ? A.parent.getClipPaths() : [];
              n.length ? this.target.clip(n, i) : i()
            }
          }
        }, {
          ...
          value: function(A, e) {
            ...
            if (t) {
              var r = (0, c.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border),
                i = (0, c.calculateBackgroundSize)(e, t, r),
                n = (0, c.calculateBackgroundPosition)(e.position, i, r),
                o = (0, c.calculateBackgroundRepeatPath)(e, n, i, r, A.bounds),
                a = Math.round(r.left + n.x),
                s = Math.round(r.top + n.y);
              this.target.renderRepeat(o, t, i, a, s)
            }
          }
        }, {
          ...
          value: function(A, e) {
            var t = (0, c.calculateBackgroungPositioningArea)(A.style.background.backgroundOrigin, A.bounds, A.style.padding, A.style.border),
              ...
              i = (0, c.calculateBackgroundPosition)(e.position, r, t),
              n = new o.Bounds(Math.round(t.left + i.x), Math.round(t.top + i.y), r.width, r.height),
              s = (0, a.parseGradient)(A, e.source, n);
            if (s) switch (s.type) {
              case a.GRADIENT_TYPE.LINEAR_GRADIENT:
                this.target.renderLinearGradient(n, s);
                break;
              case a.GRADIENT_TYPE.RADIAL_GRADIENT:
                this.target.renderRadialGradient(n, s)
            }
          }
        }, {
          key: "renderBorder",
          ...
          value: function(e) {
            ...
            var r = this.target.getTarget();
            return "production" !== A.env.NODE_ENV ? r.then(function(A) {
    ...
    e.default = B;
    var g = function(A) {
        for (var e = [], t = [], r = A.children.length, i = 0; i < r; i++) {
          var n = A.children[i];
          n.isInlineLevel() ? e.push(n) : t.push(n)
        }
        return [e, t]
      },
      h = function(A) {
        for (var e = [], t = [], r = [], i = [], n = [], o = A.contexts.length, a = 0; a < o; a++) {
          var s = A.contexts[a];
          s.container.isPositioned() || s.container.style.opacity < 1 || s.container.isTransformed() ? s.container.style.zIndex.order < 0 ? e.push(s) : s.container.style.zIndex.order > 0 ? r.push(s) : t.push(s) : s.container.isFloating() ? i.push(s) : n.push(s)
        }
        return [e, t, r, i, n]
      },
      d = function(A, e) {
  ...
  (function(A) {
    ...
    var i = function() {
      ...
      s = function() {
        function e(A, t, i) {
          r(this, e), this.options = A, this._window = i, this.origin = this.getOrigin(i.location.href), this.cache = {}, this.logger = t, this._index = 0
        }
        return i(e, [{
          key: "loadImage",
          value: function(A) {
          ...
          value: function(e) {
            var t = this;
            return this.cache[e] = new Promise(function(r, i) {
              var n = new XMLHttpRequest;
              if (n.onreadystatechange = function() {
                  if (4 === n.readyState)
                    if (200 !== n.status) i("Failed to fetch image " + e.substring(0, 256) + " with status code " + n.status);
                    else {
                      var A = new FileReader;
                ...
                }, n.responseType = "blob", t.options.imageTimeout) {
                var o = t.options.imageTimeout;
                n.timeout = o, n.ontimeout = function() {
                  return i("production" !== A.env.NODE_ENV ? "Timed out (" + o + "ms) fetching " + e.substring(0, 256) : "")
                }
              }
            ...
            var n = function(e) {
              return new Promise(function(n, o) {
                ...
                if (a.onload = function() {
                    return n(a)
                  }, e && !r || (a.crossOrigin = "anonymous"), a.onerror = o, a.src = t, !0 === a.complete && setTimeout(function() {
                    n(a)
                  }, 500), i.options.imageTimeout) {
                  var s = i.options.imageTimeout;
                  setTimeout(function() {
                    return o("production" !== A.env.NODE_ENV ? "Timed out (" + s + "ms) fetching " + t.substring(0, 256) : "")
                  }, s)
                }
              })
            };
            return this.cache[e] = h(t) && !d(t) ? o.default.SUPPORT_BASE64_DRAWING(t).then(n) : n(!0), e
          }
        }, {
          key: "isSameOrigin",
          value: function(A) {
          ...
          value: function() {
            ...
            return Promise.all(r).then(function(r) {
              return "production" !== A.env.NODE_ENV && e.logger.log("Finished loading " + r.length + " images", r), new l(t, r)
            })
          }
        }]), e
      }();
    ...
    var l = e.ResourceStore = function() {
      ...
      w = function(e, t) {
        return new Promise(function(r, i) {
          ...
          n.onload = function() {
            return r(n)
          }, n.onerror = i, n.src = e, !0 === n.complete && setTimeout(function() {
            r(n)
          }, 500), t && setTimeout(function() {
            return i("production" !== A.env.NODE_ENV ? "Timed out (" + t + "ms) loading image" : "")
          }, t)
        })
      }
  }).call(e, t(0))
  ...
  var i = function() {
    ...
    o = (function(A) {
      ...
      function A(e, t, i) {
        r(this, A), this.container = e, this.parent = t, this.contexts = [], this.children = [], this.treatAsRealStackingContext = i
      }
      return i(A, [{
        key: "getOpacity",
        value: function() {
  ...
  (function(A) {
    ...
    var i = function() {
      ...
      w = t(3),
      Q = r(w);
    e.renderElement = function e(t, r, n) {
      var a = t.ownerDocument,
        l = new g.Bounds(r.scrollX, r.scrollY, r.windowWidth, r.windowHeight),
        u = a.documentElement ? new Q.default(getComputedStyle(a.documentElement).backgroundColor) : w.TRANSPARENT,
        p = a.body ? new Q.default(getComputedStyle(a.body).backgroundColor) : w.TRANSPARENT,
        C = t === a.documentElement ? u.isTransparent() ? p.isTransparent() ? r.backgroundColor ? new Q.default(r.backgroundColor) : null : p : u : r.backgroundColor ? new Q.default(r.backgroundColor) : null;
      return (r.foreignObjectRendering ? B.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(u) {
        return u ? function(e) {
          return "production" !== A.env.NODE_ENV && n.log("Document cloned, using foreignObject rendering"), e.inlineFonts(a).then(function() {
            return e.resourceLoader.ready()
          }).then(function() {
            return new c.default(e.documentElement).render({
              backgroundColor: C,
              logger: n,
              scale: r.scale,
              x: r.x,
        ...
        }(new h.DocumentCloner(t, r, n, !0, e)) : (0, h.cloneWindow)(a, l, t, r, n, e).then(function(e) {
          var t = i(e, 3),
            a = t[0],
            l = t[1],
            c = t[2];
          "production" !== A.env.NODE_ENV && n.log("Document cloned, using computed rendering");
          var u = (0, o.NodeParser)(l, c, n),
            B = l.ownerDocument;
          return C === u.container.style.background.backgroundColor && (u.container.style.background.backgroundColor = w.TRANSPARENT), c.ready().then(function(e) {
            var t = new d.FontMetrics(B);
            "production" !== A.env.NODE_ENV && n.log("Starting renderer");
            var i = {
              backgroundColor: C,
              fontMetrics: t,
              imageStore: e,
            ...
            if (Array.isArray(r.target)) return Promise.all(r.target.map(function(A) {
              return new s.default(A, i).render(u)
            }));
            var o = new s.default(r.target, i),
              l = o.render(u);
            return !0 === r.removeContainer && (a.parentNode ? a.parentNode.removeChild(a) : "production" !== A.env.NODE_ENV && n.log("Cannot detach cloned iframe as it is not in the DOM anymore")), l
          })
        })
      })
    }
  ...
  var i = function() {
    ...
    l = function() {
      function A(e, t, i, o) {
        r(this, A), this.type = n.PATH.BEZIER_CURVE, this.start = e, this.startControl = t, this.endControl = i, this.end = o
      }
      return i(A, [{
        key: "subdivide",
        value: function(e, t) {
          var r = s(this.start, this.startControl, e),
            i = s(this.startControl, this.endControl, e),
            n = s(this.endControl, this.end, e),
            o = s(r, i, e),
            a = s(i, n, e),
            l = s(o, a, e);
          return t ? new A(this.start, r, o, l) : new A(l, a, n, this.end)
        }
      }, {
        key: "reverse",
        value: function() {
  ...
  (function(A) {
    ...
    var i = t(11),
      n = function e(t, n, o) {
        r(this, e), this.type = i.PATH.CIRCLE, this.x = t, this.y = n, this.radius = o, "production" !== A.env.NODE_ENV && (isNaN(t) && console.error("Invalid x value given for Circle"), isNaN(n) && console.error("Invalid y value given for Circle"), isNaN(o) && console.error("Invalid radius value given for Circle"))
      };
    e.default = n
  }).call(e, t(0))
}, function(A, e, t) {
  ...
  e.parseBorderRadius = function(A) {
    return o.map(function(e) {
      var t = A.getPropertyValue("border-" + e + "-radius"),
        i = t.split(" ").map(n.default.create),
        o = r(i, 2),
        a = o[0],
        s = o[1];
  ...
  e.parseMargin = function(A) {
    return n.map(function(e) {
      return new i.default(A.getPropertyValue("margin-" + e))
    })
  }
}, function(A, e, t) {
  "use strict";
  ...
  e.parseTextShadow = function(A) {
    ...
    for (var e = "", t = !1, r = [], o = [], a = 0, s = null, l = function() {
        e.length && (t ? r.push(parseFloat(e)) : s = new i.default(e)), t = !1, e = ""
      }, c = function() {
      ...
      switch (B) {
        ...
        case " ":
          ...
          break;
        default:
          0 === e.length && n.test(B) && (t = !0), e += B
      }
    }
    return l(), c(), 0 === o.length ? null : o
  }
}, function(A, e, t) {
  "use strict";
  Object.defineProperty(e, "__esModule", {
  ...
  var r = t(5),
    ...
    a = (e.parseTransform = function(A) {
      ...
      var t = A.split(" ").map(i.default.create);
      return [t[0], t[1]]
    }),
    s = function(A) {
      if ("none" === A || "string" != typeof A) return null;
