 ...
 */
final class Version20181224152904 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE picture_discount_per_retouch (id INT AUTO_INCREMENT NOT NULL, retouch_id INT DEFAULT NULL, picture_discount_id INT DEFAULT NULL, reduction NUMERIC(5, 2) NOT NULL, image_limit NUMERIC(5, 0) DEFAULT NULL, image_limit_per_user NUMERIC(5, 0) DEFAULT NULL, INDEX IDX_935D6AA4B0C9087F (retouch_id), INDEX IDX_935D6AA4D23424FC (picture_discount_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
