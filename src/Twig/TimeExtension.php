...
class TimeExtension extends AbstractExtension
{
    ...
    */
    ...
    {
        return array(
          new TwigFilter('hour', [$this, 'hourFilter'], ['is_safe' => ['html']]),
          new TwigFilter('distance_of_time_in_words', array($this, 'distanceOfTimeInWordsFilter')),
          new TwigFilter('time_ago_in_words', array($this, 'timeAgoInWordsFilter')),
        );
    }
    ...
    */
    ...
    public function hourFilter($value)
    {
